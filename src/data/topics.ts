...
export const topics: Topic[] = [
  ...
  // ============================================================
  // hw/ai_chokepoints — AI 瓶頸總覽與遷移分析
  // ============================================================
  {
    id: "ai_chokepoints",
    slug: "ai_chokepoints",
    category: "hw",
    name: "AI 瓶頸總覽與遷移分析",
    name_en: "AI Infrastructure Chokepoints & Migration",
    description:
      "從瓶頸思維(chokepoint thesis)分析 AI 算力建置的六層結構性瓶頸：材料、設備、封裝、光通訊、電力、記憶體儲存。追蹤瓶頸遷移路徑與寡佔受益者。",
    icon: "🚧",
    color: "#dc2626",
    flowSummary: "材料 → 設備 → 封裝 → 光通訊 → 電力散熱 → 記憶體儲存",
    sections: [
      {
        id: "chokepoint-framework",
        name: "瓶頸思維框架",
        name_en: "Chokepoint Thesis Framework",
        keyInfo: "AI 建置如水流通過水管，最窄處決定整體流量，寡佔結構讓供應商擁有結構性定價權",
        marketType: "high_growth",
        companies: [
          { id: "tsmc", name: "台積電", ticker: "2330.TW", country: "TW", role: "先進製程 + CoWoS 雙重瓶頸樞紐，AI 算力擴張關鍵節點" },
          { id: "asml", name: "ASML", ticker: "ASML", country: "NL", role: "EUV 唯一供應商，極致瓶頸代表" },
          { id: "sk_hynix", name: "SK Hynix", ticker: "000660.KS", country: "KR", role: "HBM 領導者，AI 加速器標配記憶體" },
          { id: "vertiv", name: "Vertiv", ticker: "VRT", country: "US", role: "液冷與電力管理樞紐，資料中心瓶頸解方" },
        ],
        relationships: [
          "瓶頸思維強調 AI 算力擴張受限於最窄環節，非整體產能",
          "ASML、TSMC、SK Hynix、Vertiv 各自代表設備、製程、記憶體、電力散熱四大瓶頸代表",
          "寡佔結構使瓶頸供應商擁有結構性定價權與長期毛利率優勢",
        ],
      },
      {
        id: "chokepoint-materials",
        name: "材料瓶頸",
        name_en: "Materials Chokepoint",
        keyInfo: "高純度矽晶圓、光阻劑、特殊氣體由 2-3 家日本廠商壟斷，無法快速替代",
        marketType: "oligopoly",
        companies: [
          { id: "shin_etsu", name: "信越化學", ticker: "4063.T", country: "JP", role: "全球矽晶圓龍頭，半導體基板必備材料", marketShare: "~32%" },
          { id: "sumco", name: "SUMCO", ticker: "3436.T", country: "JP", role: "矽晶圓第二大廠，與信越合計超過 55%", marketShare: "~25%" },
          { id: "resonac", name: "Resonac (昭和電工)", ticker: "4004.T", country: "JP", role: "先進封裝材料、CMP 漿料壟斷" },
          { id: "ajinomoto", name: "味之素", ticker: "2802.T", country: "JP", role: "ABF 載板絕緣膜 100% 壟斷，AI 晶片載板必備" },
        ],
        relationships: [
          "信越與 SUMCO 雙寡頭壟斷矽晶圓，新進入者建廠週期 5-7 年",
          "味之素 ABF 為先進封裝關鍵材料，無可替代供應商",
          "日本材料廠商擁有結構性護城河，AI 晶片成長直接帶動營收",
        ],
      },
      {
        id: "chokepoint-tools",
        name: "製程設備瓶頸",
        name_en: "Process Tools Chokepoint",
        keyInfo: "ASML EUV 全球唯一供應商，蝕刻/沉積設備由 4 家日美廠商寡佔",
        marketType: "monopoly",
        companies: [
          { id: "asml", name: "ASML", ticker: "ASML", country: "NL", role: "EUV 微影設備獨佔，先進製程不可或缺", marketShare: "~100%" },
          { id: "applied_materials", name: "Applied Materials", ticker: "AMAT", country: "US", role: "沉積與蝕刻設備領導" },
          { id: "lam_research", name: "Lam Research", ticker: "LRCX", country: "US", role: "蝕刻設備領導者，3D NAND 與先進製程必備" },
          { id: "tokyo_electron", name: "Tokyo Electron", ticker: "8035.T", country: "JP", role: "塗布/顯影設備壟斷，與 ASML 緊密配套" },
          { id: "kla", name: "KLA", ticker: "KLAC", country: "US", role: "製程檢測設備領導", marketShare: "~60%" },
        ],
        relationships: [
          "ASML 壟斷 EUV，與 TEL 形成塗布/顯影/微影黃金組合",
          "AMAT 與 Lam Research 在沉積/蝕刻設備直接競爭，合計超過 60%",
          "五大設備廠商皆為先進製程不可繞過的瓶頸，毛利率長期維持高位",
        ],
      },
      {
        id: "chokepoint-cowos",
        name: "先進封裝瓶頸 (CoWoS)",
        name_en: "CoWoS Advanced Packaging Chokepoint",
        keyInfo: "台積電 CoWoS 產能訂單已 booked 至 2027+，產能擴張為 AI GPU 出貨直接瓶頸",
        marketType: "monopoly",
        companies: [
          { id: "tsmc", name: "台積電 CoWoS", ticker: "2330.TW", country: "TW", role: "CoWoS-S/CoWoS-L 先進封裝壟斷，AI GPU 必經", marketShare: "~85%" },
          { id: "ase", name: "日月光", ticker: "3711.TW", country: "TW", role: "OSAT 委外服務，承接 CoWoS 溢出產能" },
          { id: "amkor", name: "Amkor", ticker: "AMKR", country: "US", role: "美國 CoWoS 補位，亞利桑那廠擴建中" },
          { id: "besi", name: "BESI", ticker: "BESI.AS", country: "NL", role: "混合鍵合 (Hybrid Bonding) 設備壟斷" },
          { id: "kulicke_soffa", name: "Kulicke & Soffa", ticker: "KLIC", country: "US", role: "打線與接合設備，TCB 熱壓鍵合主要供應商" },
        ],
        relationships: [
          "台積電 CoWoS 為 AI GPU 出貨最直接瓶頸，產能擴張節奏決定 NVIDIA 出貨",
          "BESI 混合鍵合設備為 HBM4 與 3D 封裝關鍵，與台積電深度綁定",
          "ASE 與 Amkor 為主要委外承接夥伴，分擔 CoWoS 溢出需求",
        ],
      },
      {
        id: "chokepoint-optics",
        name: "光通訊瓶頸",
        name_en: "Light / Optics Chokepoint",
        keyInfo: "AI 資料中心互連從電轉光是必然趨勢，800G/1.6T 光模組需求爆發",
        marketType: "oligopoly",
        companies: [
          { id: "coherent", name: "Coherent", ticker: "COHR", country: "US", role: "III-V 雷射元件與光收發模組領導", marketShare: "~35%" },
          { id: "lumentum", name: "Lumentum", ticker: "LITE", country: "US", role: "VCSEL/光收發元件，AI 互連受惠者", marketShare: "~25%" },
          { id: "innolight", name: "Innolight (中際旭創)", ticker: "300308.SZ", country: "CN", role: "全球光模組龍頭，800G/1.6T 主要供應" },
          { id: "astera_labs", name: "Astera Labs", ticker: "ALAB", country: "US", role: "PCIe Retimer 領導，AI 機櫃內互連關鍵" },
          { id: "credo", name: "Credo Technology", ticker: "CRDO", country: "US", role: "AEC 主動電纜，短距離高速互連方案" },
          { id: "corning", name: "Corning", ticker: "GLW", country: "US", role: "光纖領導者，AI 資料中心骨幹光纖" },
        ],
        relationships: [
          "Coherent 與 Lumentum 在 III-V 雷射元件直接競爭，合計約 60% 市佔",
          "Innolight 主導中國光模組市場，與 Coherent 在全球 800G 市場競爭",
          "Astera Labs 與 Credo 分別主導 PCIe Retimer 與 AEC，互補 AI 機櫃互連方案",
        ],
      },
      {
        id: "chokepoint-power",
        name: "電力與電網瓶頸",
        name_en: "Power & Grid Chokepoint",
        keyInfo: "美國電網變壓器交貨期 2-4 年，AI 資料中心新建排程被電力供應綁定",
        marketType: "high_growth",
        companies: [
          { id: "ge_vernova", name: "GE Vernova", ticker: "GEV", country: "US", role: "燃氣輪機 + 高壓變壓器，電網升級核心" },
          { id: "eaton", name: "Eaton", ticker: "ETN", country: "US", role: "電力管理與配電解決方案" },
          { id: "vertiv", name: "Vertiv", ticker: "VRT", country: "US", role: "UPS 與配電基礎設施" },
          { id: "schneider", name: "Schneider Electric", ticker: "SU.PA", country: "FR", role: "電力基礎設施與資料中心整體方案" },
          { id: "constellation", name: "Constellation Energy", ticker: "CEG", country: "US", role: "核電 PPA 主要供應，Microsoft 等 Hyperscaler 簽約對象" },
          { id: "quanta", name: "Quanta Services", ticker: "PWR", country: "US", role: "電網工程建設，輸配電施工龍頭" },
        ],
        relationships: [
          "GE Vernova 燃氣輪機與變壓器同時供應，雙重瓶頸樞紐",
          "Eaton、Vertiv、Schneider 在資料中心電力配電市場直接競爭",
          "Constellation 簽訂 Microsoft 三哩島核電 PPA，AI 電力需求帶動核電復興",
        ],
      },
      {
        id: "chokepoint-cooling",
        name: "散熱瓶頸",
        name_en: "Cooling Chokepoint",
        keyInfo: "GB200 NVL72 機櫃 120kW，液冷已成必選，CDU 與 cold plate 供應吃緊",
        marketType: "high_growth",
        companies: [
          { id: "vertiv", name: "Vertiv", ticker: "VRT", country: "US", role: "CDU (冷卻分配單元) 領導，AI 液冷必備" },
          { id: "auras", name: "雙鴻", ticker: "3324.TW", country: "TW", role: "cold plate 散熱模組主力供應" },
          { id: "asia_vital", name: "奇鋐", ticker: "3017.TW", country: "TW", role: "液冷散熱模組，NVIDIA 主要供應鏈" },
          { id: "kaori", name: "高力", ticker: "8996.TW", country: "TW", role: "熱交換器，液冷系統核心元件" },
          { id: "modine", name: "Modine", ticker: "MOD", country: "US", role: "工業冷卻與 CDU 解決方案" },
        ],
        relationships: [
          "Vertiv 主導 CDU 市場，與 Modine 在美國市場競爭",
          "雙鴻、奇鋐、高力為台灣液冷三雄，分別主攻 cold plate、模組、熱交換器",
          "GB200/GB300 機櫃普及推升液冷滲透率，台廠受惠度高",
        ],
      },
      {
        id: "chokepoint-memory",
        name: "記憶體瓶頸",
        name_en: "Memory Chokepoint",
        keyInfo: "HBM 由 3 家寡佔，每片 H100 需 80GB HBM，產能擴張兩年才能到位",
        marketType: "oligopoly",
        companies: [
          { id: "sk_hynix", name: "SK Hynix", ticker: "000660.KS", country: "KR", role: "HBM3E 領導者，NVIDIA 主要供應", marketShare: "~53%" },
          { id: "samsung", name: "Samsung", ticker: "005930.KS", country: "KR", role: "HBM3E/HBM4 量產，追趕 SK Hynix", marketShare: "~32%" },
          { id: "micron", name: "Micron", ticker: "MU", country: "US", role: "HBM3E 美系供應，打入 NVIDIA 與 AMD 供應鏈", marketShare: "~15%" },
        ],
        relationships: [
          "SK Hynix 領先 HBM3E 量產，Samsung 良率追趕中",
          "Micron 美系身份具地緣優勢，受惠於美國 AI 晶片供應鏈本土化",
          "三家 HBM 寡佔結構使定價權強，毛利率持續優於 DRAM 平均",
        ],
      },
      {
        id: "chokepoint-eda",
        name: "EDA 雙寡佔瓶頸",
        name_en: "EDA Duopoly Chokepoint",
        keyInfo: "所有先進晶片設計必經 Synopsys + Cadence，無替代方案，毛利率 80%+",
        marketType: "monopoly",
        companies: [
          { id: "synopsys", name: "Synopsys", ticker: "SNPS", country: "US", role: "EDA 全流程工具領導", marketShare: "~55%" },
          { id: "cadence", name: "Cadence", ticker: "CDNS", country: "US", role: "EDA 與系統設計工具", marketShare: "~33%" },
          { id: "arm", name: "ARM", ticker: "ARM", country: "GB", role: "CPU IP 授權，先進晶片設計必經核心架構" },
        ],
        relationships: [
          "Synopsys 與 Cadence 雙寡頭壟斷 EDA 工具，合計超過 85% 市佔",
          "ARM CPU IP 為先進晶片設計必經授權，與 EDA 工具形成設計端雙重瓶頸",
          "EDA 雙寡頭與 ARM 三家合計毛利率 80%+，結構性護城河極深",
        ],
      },
      {
        id: "chokepoint-migration",
        name: "瓶頸遷移路徑",
        name_en: "Bottleneck Migration Path",
        keyInfo: "瓶頸動態遷移：解決 CoWoS → 跳到 HBM → 跳到電力 → 跳到散熱",
        marketType: "emerging",
        companies: [
          { id: "tsmc", name: "台積電 (短期 2026)", ticker: "2330.TW", country: "TW", role: "CoWoS 仍為 2026 主要瓶頸，產能擴張節奏關鍵" },
          { id: "sk_hynix", name: "SK Hynix (短期 2026)", ticker: "000660.KS", country: "KR", role: "HBM3E/HBM4 為 2026 記憶體瓶頸主受益者" },
          { id: "vertiv", name: "Vertiv (中期 2027)", ticker: "VRT", country: "US", role: "液冷普及為 2027 瓶頸焦點" },
          { id: "ge_vernova", name: "GE Vernova (中期 2027)", ticker: "GEV", country: "US", role: "燃氣輪機與電網升級為 2027 主要受益者" },
          { id: "constellation", name: "Constellation (長期 2028+)", ticker: "CEG", country: "US", role: "核電 PPA 為 2028+ 長期電力解方" },
          { id: "pure_storage", name: "Pure Storage (長期 2028+)", ticker: "PSTG", country: "US", role: "AI 儲存層為下一階段瓶頸候選" },
          { id: "vast_data", name: "VAST Data (長期 2028+)", ticker: "Private", country: "US", role: "分散式 AI 儲存新興玩家" },
        ],
        relationships: [
          "瓶頸具動態遷移特性，解決一處瓶頸後另一處馬上凸顯",
          "短期 (2026) CoWoS 與 HBM 為焦點，中期 (2027) 轉向電力與液冷",
          "長期 (2028+) 核電與 AI 儲存層將成為新瓶頸，提早布局受益者具先發優勢",
        ],
      },
    ],
  },
  // ============================================================
  // X. hl/glp1 — 瘦瘦針 / GLP-1 減重藥物
  // ============================================================
  {
    id: "glp1",
    slug: "glp1",
    category: "hl",
    name: "瘦瘦針 / GLP-1 減重藥物",
    name_en: "GLP-1 Weight Loss & Obesity Drugs",
    description:
      "GLP-1 受體促效劑掀起代謝醫學革命，從減重、糖尿病擴展至心衰、腎病、阿茲海默症，2030 年市場預估突破 1500 億美元，胜肽供應鏈與 CDMO 全面短缺。",
    icon: "💉",
    color: "#10b981",
    flowSummary: "GLP-1 機制 → 藥物開發 → 製造供應 → 通路與支付 → 新適應症",
    sections: [
      {
        id: "glp1-mechanism",
        name: "GLP-1 機制與藥物原理",
        name_en: "GLP-1 Mechanism & Drug Principles",
        keyInfo: "GLP-1 受體促效劑透過延緩胃排空、抑制食慾與促進胰島素分泌，平均減重 15-25%",
        marketType: "oligopoly",
        companies: [
          { id: "novo_mech", name: "Novo Nordisk", ticker: "NVO", country: "DK", role: "Semaglutide 單一 GLP-1 促效劑，Ozempic/Wegovy/Rybelsus 系列開發者" },
          { id: "lilly_mech", name: "Eli Lilly", ticker: "LLY", country: "US", role: "Tirzepatide 為 GIP/GLP-1 雙重促效劑，Retatrutide 為 GIP/GLP-1/Glucagon 三重促效劑" },
          { id: "amgen_mech", name: "Amgen", ticker: "AMGN", country: "US", role: "MariTide 為 GLP-1 促效/GIP 拮抗複合機制，月針一次給藥" },
          { id: "altimmune_mech", name: "Altimmune", ticker: "ALT", country: "US", role: "Pemvidutide 為 GLP-1/Glucagon 雙重促效劑，主攻 MASH 與肥胖" },
        ],
        relationships: [
          "單一 GLP-1 機制由 Novo 主導，雙重/三重機制由 Lilly 領先佈局",
          "三重機制 Retatrutide 臨床試驗顯示 24% 減重效果，創新藥金標準",
          "MariTide 採差異化 GIP 拮抗機制，挑戰 Lilly Tirzepatide 雙重促效設計",
        ],
      },
      {
        id: "glp1-incumbent",
        name: "一代 GLP-1 雙雄壟斷",
        name_en: "First-gen GLP-1 Duopoly",
        keyInfo: "Novo Nordisk 與 Eli Lilly 合計拿下全球 GLP-1 市場超過 90% 份額",
        marketType: "oligopoly",
        companies: [
          { id: "novo_nordisk", name: "Novo Nordisk", ticker: "NVO", country: "DK", role: "Ozempic（糖尿病）與 Wegovy（減重）製造商，Semaglutide 全球銷售額破 400 億美元", marketShare: "~55%" },
          { id: "eli_lilly", name: "Eli Lilly", ticker: "LLY", country: "US", role: "Mounjaro（糖尿病）與 Zepbound（減重）製造商，Tirzepatide 為市場成長最快藥物", marketShare: "~40%" },
          { id: "sanofi_glp1", name: "Sanofi", ticker: "SNY", country: "FR", role: "Lyxumia/Soliqua（lixisenatide）市佔低，逐步退出 GLP-1 戰場" },
          { id: "astrazeneca_glp1", name: "AstraZeneca", ticker: "AZN", country: "UK", role: "Bydureon（exenatide）為早期 GLP-1 藥物，市佔已被新藥取代" },
        ],
        relationships: [
          "Novo 與 Lilly 形成雙寡占，2025 年合計營收超過 700 億美元",
          "Lilly Tirzepatide 減重效果（22%）優於 Novo Semaglutide（15%），市佔加速侵蝕",
          "Sanofi 與 AZ 為早期 GLP-1 玩家，已被新一代藥物邊緣化",
        ],
      },
      {
        id: "glp1-next-gen",
        name: "下一代多重激素同效",
        name_en: "Next-gen Multi-agonist",
        keyInfo: "三重激素促效劑 Retatrutide 減重達 24%，2027 年預計上市改寫競爭格局",
        marketType: "emerging",
        companies: [
          { id: "lilly_reta", name: "Eli Lilly Retatrutide", ticker: "LLY", country: "US", role: "GIP/GLP-1/Glucagon 三重促效劑，Phase 3 臨床中" },
          { id: "amgen_marit", name: "Amgen MariTide", ticker: "AMGN", country: "US", role: "GLP-1/GIP 受體調節，月針一次，Phase 2 數據顯示 20% 減重" },
          { id: "viking", name: "Viking Therapeutics", ticker: "VKTX", country: "US", role: "VK2735 雙重促效劑開發者，併購標的熱門" },
          { id: "structure_tx", name: "Structure Therapeutics", ticker: "GPCR", country: "US", role: "GSBR-209 口服小分子 GLP-1，與胜肽藥差異化" },
          { id: "altimmune_next", name: "Altimmune Pemvidutide", ticker: "ALT", country: "US", role: "GLP-1/Glucagon 雙重促效劑，主攻 MASH 適應症" },
        ],
        relationships: [
          "Lilly Retatrutide 為三重激素同效藥物先驅，預期奪下下一代龍頭",
          "Amgen MariTide 主打月針一次給藥便利性，挑戰週針標準",
          "Viking Therapeutics 為熱門併購標的，Pfizer、Roche、Merck 皆傳出洽談",
        ],
      },
      {
        id: "glp1-oral",
        name: "口服 GLP-1 開發競賽",
        name_en: "Oral GLP-1 Development Race",
        keyInfo: "口服 GLP-1 突破注射劑型限制，2026 年起多款進入 Phase 3，預計搶下 30% 市場",
        marketType: "emerging",
        companies: [
          { id: "pfizer_oral", name: "Pfizer", ticker: "PFE", country: "US", role: "Danuglipron 口服 GLP-1 開發中，已放棄首版但持續優化新版本" },
          { id: "roche_oral", name: "Roche", ticker: "RHHBY", country: "CH", role: "CT-996 口服小分子 GLP-1，併購 Carmot 後快速推進" },
          { id: "az_oral", name: "AstraZeneca", ticker: "AZN", country: "UK", role: "AZD5004 口服 GLP-1，與 Eccogene 共同開發" },
          { id: "structure_oral", name: "Structure Therapeutics", ticker: "GPCR", country: "US", role: "Aleniglipron (GSBR-209) 口服 GLP-1，Phase 2b 數據領先" },
          { id: "novo_oral", name: "Novo Nordisk Rybelsus", ticker: "NVO", country: "DK", role: "Semaglutide 口服版本，第一個獲批口服 GLP-1，市場驗證者" },
        ],
        relationships: [
          "Novo Rybelsus 為首個獲批口服 GLP-1，但生物可用性僅 1%，效果有限",
          "Pfizer、Roche、AZ 押注小分子口服 GLP-1，挑戰胜肽注射型主流",
          "Structure Therapeutics 為熱門併購標的，小分子設計具差異化優勢",
        ],
      },
      {
        id: "glp1-cdmo",
        name: "CDMO 製造供應鏈",
        name_en: "GLP-1 CDMO Manufacturing",
        keyInfo: "全球 GLP-1 注射型胜肽產能短缺持續至 2027 年，CDMO 議價力倍增",
        marketType: "high_growth",
        companies: [
          { id: "catalent_glp", name: "Catalent (Novo Holdings)", ticker: "NVO", country: "US", role: "Novo 2024 年以 165 億美元收購，三廠專供 Wegovy 充填" },
          { id: "lonza", name: "Lonza", ticker: "LONN.SW", country: "CH", role: "全球最大 CDMO，胜肽合成與無菌充填產能擴張中" },
          { id: "samsung_bio", name: "Samsung Biologics", ticker: "207940.KS", country: "KR", role: "亞洲最大生物製劑 CDMO，跨入胜肽合成" },
          { id: "wuxi_bio", name: "WuXi Biologics", ticker: "2269.HK", country: "CN", role: "中國 CDMO 龍頭，受美中地緣政治影響" },
          { id: "thermo_glp", name: "Thermo Fisher (Patheon)", ticker: "TMO", country: "US", role: "無菌注射劑充填產能領先，Lilly 主要 CDMO 夥伴" },
        ],
        relationships: [
          "Novo 以 165 億美元收購 Catalent 鎖定垂直整合產能",
          "Lonza、Samsung、Thermo Fisher 為 Lilly 與其他原廠主要 CDMO",
          "WuXi Bio 受美國《生物安全法案》衝擊，西方訂單流向 Lonza 與 Samsung",
        ],
      },
      {
        id: "glp1-peptide",
        name: "胜肽合成原料供應",
        name_en: "Peptide Synthesis Raw Materials",
        keyInfo: "GLP-1 胜肽合成的固相合成樹脂與胺基酸原料短缺，2025-2027 持續吃緊",
        marketType: "oligopoly",
        companies: [
          { id: "bachem", name: "Bachem", ticker: "BANB.SW", country: "CH", role: "全球最大胜肽 API 製造商，Novo 與 Lilly 共同供應商", marketShare: "~30%" },
          { id: "polypeptide", name: "PolyPeptide Group", ticker: "PPGN.SW", country: "CH", role: "胜肽 API 第二大廠，產能擴建中" },
          { id: "croda", name: "Croda International", ticker: "CRDA.L", country: "UK", role: "脂質與佐劑供應，GLP-1 製劑必需原料" },
          { id: "lipoid_evo", name: "Evonik (Lipoid)", ticker: "EVK.DE", country: "DE", role: "藥用脂質與 LNP 供應，GLP-1 製劑與 mRNA 共用原料" },
          { id: "merck_kgaa", name: "Merck KGaA", ticker: "MRK.DE", country: "DE", role: "胺基酸與胜肽合成試劑供應，生命科學部門領先" },
        ],
        relationships: [
          "Bachem 與 PolyPeptide 為 GLP-1 胜肽 API 雙寡占供應商",
          "Croda 與 Evonik 提供注射製劑必需的脂質賦形劑",
          "胜肽原料短缺帶動 Bachem 股價自 2023 年起翻倍上漲",
        ],
      },
      {
        id: "glp1-new-indications",
        name: "新適應症臨床擴展",
        name_en: "New Indication Expansion",
        keyInfo: "GLP-1 已獲批心血管適應症，腎病、阿茲海默症、成癮症臨床數據陸續解讀",
        marketType: "high_growth",
        companies: [
          { id: "novo_select", name: "Novo SELECT 試驗", ticker: "NVO", country: "DK", role: "Wegovy 證實降低 MACE 心血管事件 20%，2024 年獲批心血管適應症" },
          { id: "novo_flow", name: "Novo FLOW 試驗", ticker: "NVO", country: "DK", role: "Semaglutide 顯示降低糖尿病腎病進展 24%" },
          { id: "lilly_summit", name: "Lilly SUMMIT 試驗", ticker: "LLY", country: "US", role: "Tirzepatide 改善 HFpEF 心衰症狀，2024 年數據陽性" },
          { id: "novo_evoke", name: "Novo EVOKE 試驗", ticker: "NVO", country: "DK", role: "Semaglutide 評估早期阿茲海默症療效，2025-2026 解盲" },
          { id: "addiction_research", name: "成癮症研究", ticker: "LLY", country: "US", role: "Novo 與 Lilly 探索酒精、尼古丁、鴉片成癮治療潛力" },
        ],
        relationships: [
          "心血管適應症獲批後，GLP-1 進入保險與 Medicare 給付，市場再放大",
          "腎病與心衰適應症使 GLP-1 與 SGLT2 抑制劑直接競爭",
          "阿茲海默症 EVOKE 試驗成功將開啟千億美元新市場",
        ],
      },
      {
        id: "glp1-side-effects",
        name: "副作用管理與監測",
        name_en: "Side Effect Management",
        keyInfo: "GLP-1 用戶 70% 出現腸胃不適，肌肉流失與視網膜病變受密切監控",
        marketType: "emerging",
        companies: [
          { id: "regeneron_muscle", name: "Regeneron Trevogrumab", ticker: "REGN", country: "US", role: "抗 Myostatin 抗體開發中，搭配 GLP-1 防止肌肉流失" },
          { id: "scholar_rock", name: "Scholar Rock Apitegromab", ticker: "SRRK", country: "US", role: "選擇性 Myostatin 抑制劑，肌肉保護臨床數據領先" },
          { id: "veru", name: "Veru Enobosarm", ticker: "VERU", country: "US", role: "選擇性雄性素受體調節劑，預防 GLP-1 肌肉流失" },
          { id: "biohaven", name: "Biohaven Taldefgrobep", ticker: "BHVN", country: "US", role: "Myostatin 抑制劑，肥胖與肌肉萎縮適應症" },
        ],
        relationships: [
          "Regeneron 與 Lilly 合作開發抗 Myostatin 配方，與 Tirzepatide 共投藥",
          "肌肉保護藥物為 GLP-1 補充劑型新賽道，多家公司投入",
          "FDA 要求 GLP-1 廠商持續監測視網膜病變與胃癱風險",
        ],
      },
      {
        id: "glp1-distribution",
        name: "全球通路與遠距醫療",
        name_en: "Distribution & Telehealth",
        keyInfo: "美國遠距醫療佔 Wegovy/Zepbound 處方 30%，複方藥房需求暴增",
        marketType: "high_growth",
        companies: [
          { id: "hims", name: "Hims & Hers Health", ticker: "HIMS", country: "US", role: "遠距減重平台，個人化 GLP-1 處方領先業者" },
          { id: "ro", name: "Ro (private)", ticker: "", country: "US", role: "遠距醫療平台，與 Lilly Direct 合作獨家通路" },
          { id: "noom", name: "Noom (private)", ticker: "", country: "US", role: "數位減重平台，整合 GLP-1 處方服務" },
          { id: "weightwatchers", name: "WeightWatchers", ticker: "WW", country: "US", role: "傳統減重品牌轉型，併購 Sequence 切入 GLP-1 通路" },
          { id: "cvs", name: "CVS Health", ticker: "CVS", country: "US", role: "PBM 與藥房通路雙重角色，影響 GLP-1 給付決策" },
          { id: "lilly_direct", name: "Lilly Direct", ticker: "LLY", country: "US", role: "Lilly 自建 D2C 通路，繞過 PBM 直接配送 Zepbound" },
        ],
        relationships: [
          "Hims 與 Ro 為遠距 GLP-1 處方雙雄，2025 年營收皆翻倍成長",
          "Lilly Direct 自建 D2C 通路繞過 PBM，挑戰傳統藥品流通",
          "CVS 與 Express Scripts 掌控保險給付清單，決定 GLP-1 用戶可近性",
        ],
      },
    ],
  },
  ...
  // ============================================================
  {
    ...
    category: "hl",
    name: "慢性病新藥",
    name_en: "Chronic Disease New Drugs",
    description:
      "心血管、代謝、自體免疫等慢性病新藥進入創新爆發期，從脂蛋白(a)抑制劑、CGRP 偏頭痛藥到阿茲海默症抗體療法，重塑全球高齡化醫療結構與藥品市場版圖。",
    icon: "💊",
    color: "#0ea5e9",
    flowSummary: "心血管 → 代謝 → 自體免疫 → 慢性發炎 → 罕見病",
    sections: [
      {
        id: "chronic-cv",
        name: "心血管創新藥",
        name_en: "Cardiovascular Innovation",
        keyInfo: "脂蛋白(a) 抑制劑為心血管藥物聖盃，2026-2027 多款 Phase 3 解盲",
        marketType: "oligopoly",
        companies: [
          { id: "lilly_lpa", name: "Eli Lilly Lepodisiran", ticker: "LLY", country: "US", role: "Lp(a) siRNA 抑制劑，年針兩次給藥便利性領先" },
          { id: "novartis_olpa", name: "Novartis Pelacarsen", ticker: "NVS", country: "CH", role: "Lp(a) ASO 反義核酸抑制劑，Phase 3 HORIZON 試驗中" },
          { id: "amgen_olp", name: "Amgen Olpasiran", ticker: "AMGN", country: "US", role: "Lp(a) siRNA 抑制劑，Phase 3 OCEAN(a) 試驗中" },
          { id: "amgen_repatha", name: "Amgen Repatha", ticker: "AMGN", country: "US", role: "PCSK9 抑制劑（evolocumab），LDL 降幅 60% 標竿藥物" },
          { id: "regeneron_praluent", name: "Regeneron Praluent", ticker: "REGN", country: "US", role: "PCSK9 抑制劑（alirocumab），與 Sanofi 共同開發" },
          { id: "novartis_leqvio", name: "Novartis Leqvio", ticker: "NVS", country: "CH", role: "PCSK9 siRNA 半年針，便利性顛覆 PCSK9 月針格局" },
        ],
        relationships: [
          "Lp(a) 抑制劑三雄（Lilly、Novartis、Amgen）爭奪首個獲批藥物地位",
          "Novartis Leqvio 以半年針給藥革新 PCSK9 用藥模式",
          "Amgen Repatha 與 Regeneron Praluent 在 PCSK9 月針市場直接競爭",
        ],
      },
      {
        id: "chronic-diabetes",
        name: "糖尿病新藥（非 GLP-1）",
        name_en: "Diabetes Beyond GLP-1",
        keyInfo: "SGLT2 抑制劑為糖尿病、心衰、腎病三適應症金標準，2025 年市場規模超過 300 億美元",
        marketType: "oligopoly",
        companies: [
          { id: "boehringer_jardiance", name: "Boehringer Jardiance", ticker: "", country: "DE", role: "Empagliflozin SGLT2 抑制劑，與 Lilly 共同行銷", marketShare: "~40%" },
          { id: "az_farxiga", name: "AstraZeneca Farxiga", ticker: "AZN", country: "UK", role: "Dapagliflozin SGLT2 抑制劑，糖尿病/心衰/腎病三適應症", marketShare: "~30%" },
          { id: "jnj_invokana", name: "J&J Invokana", ticker: "JNJ", country: "US", role: "Canagliflozin SGLT2 抑制劑，市佔下滑中" },
          { id: "merck_steglatro", name: "Merck Steglatro", ticker: "MRK", country: "US", role: "Ertugliflozin SGLT2 抑制劑，與 Pfizer 共同開發" },
          { id: "lilly_jardiance", name: "Eli Lilly", ticker: "LLY", country: "US", role: "Jardiance 共同行銷夥伴，獲利分潤" },
        ],
        relationships: [
          "Boehringer Jardiance 與 AZ Farxiga 寡占 SGLT2 全球市場",
          "SGLT2 與 GLP-1 在糖尿病用藥領域形成雙主流互補配方",
          "SGLT2 在心衰與腎病適應症成標準療法，市場仍持續擴大",
        ],
      },
      {
        id: "chronic-autoimmune",
        name: "自體免疫疾病",
        name_en: "Autoimmune Diseases",
        keyInfo: "Humira 生物相似藥導入後市場洗牌，JAK 抑制劑與 IL-23 抗體搶佔市佔",
        marketType: "oligopoly",
        companies: [
          { id: "abbvie", name: "AbbVie Humira/Skyrizi/Rinvoq", ticker: "ABBV", country: "US", role: "Humira 全球藥王退場，Skyrizi（IL-23）與 Rinvoq（JAK1）接棒" },
          { id: "pfizer_jak", name: "Pfizer Xeljanz/Cibinqo", ticker: "PFE", country: "US", role: "JAK 抑制劑開發者，受 FDA 黑框警告影響" },
          { id: "lilly_olumiant", name: "Eli Lilly Olumiant", ticker: "LLY", country: "US", role: "Baricitinib JAK1/2 抑制劑，類風濕關節炎與圓禿適應症" },
          { id: "jnj_tremfya", name: "J&J Tremfya", ticker: "JNJ", country: "US", role: "Guselkumab IL-23 抗體，乾癬與克隆氏症雙適應症" },
          { id: "amgen_biosim", name: "Amgen Amjevita", ticker: "AMGN", country: "US", role: "Humira 生物相似藥領先業者，2023 年美國市場首發" },
          { id: "celltrion", name: "Celltrion", ticker: "068270.KS", country: "KR", role: "全球生物相似藥龍頭，Inflectra、Yuflyma 領先佈局" },
        ],
        relationships: [
          "AbbVie Humira 自 2023 年起面臨生物相似藥競爭，營收快速下滑",
          "AbbVie 以 Skyrizi 與 Rinvoq 雙引擎接棒，2025 年合計營收破 250 億美元",
          "JAK 抑制劑受 FDA 心血管風險警告，使用量受限於二線療法",
        ],
      },
      {
        id: "chronic-cgrp",
        name: "CGRP 偏頭痛藥",
        name_en: "CGRP Migraine Drugs",
        keyInfo: "CGRP 抑制劑徹底改變偏頭痛預防與急性治療，2025 年市場規模超過 80 億美元",
        marketType: "emerging",
        companies: [
          { id: "abbvie_ubrelvy", name: "AbbVie Ubrelvy/Qulipta", ticker: "ABBV", country: "US", role: "口服 CGRP 抑制劑，急性與預防雙適應症" },
          { id: "pfizer_nurtec", name: "Pfizer Nurtec", ticker: "PFE", country: "US", role: "Rimegepant 口服 CGRP，併購 Biohaven 取得" },
          { id: "lundbeck_vyepti", name: "Lundbeck Vyepti", ticker: "LUN.CO", country: "DK", role: "Eptinezumab 靜脈 CGRP 抗體，季針給藥" },
          { id: "amgen_aimovig", name: "Amgen Aimovig", ticker: "AMGN", country: "US", role: "Erenumab CGRP 受體抗體，首個獲批 CGRP 預防藥" },
          { id: "lilly_emgality", name: "Eli Lilly Emgality", ticker: "LLY", country: "US", role: "Galcanezumab CGRP 抗體，月針預防偏頭痛" },
          { id: "teva_ajovy", name: "Teva Ajovy", ticker: "TEVA", country: "IL", role: "Fremanezumab CGRP 抗體，月針或季針給藥" },
        ],
        relationships: [
          "CGRP 注射型四雄（Amgen、Lilly、Teva、Lundbeck）瓜分預防用藥市場",
          "Pfizer Nurtec 與 AbbVie Qulipta 在口服 CGRP 直接競爭",
          "Pfizer 以 116 億美元併購 Biohaven 取得 CGRP 領域入場券",
        ],
      },
      {
        id: "chronic-alzheimer",
        name: "阿茲海默症新藥",
        name_en: "Alzheimer's Disease Drugs",
        keyInfo: "抗類澱粉斑塊抗體療法 Kisunla 與 Leqembi 開啟阿茲海默症修飾治療時代",
        marketType: "emerging",
        companies: [
          { id: "lilly_kisunla", name: "Eli Lilly Kisunla", ticker: "LLY", country: "US", role: "Donanemab 抗 Aβ 抗體，可在達到清除目標後停藥" },
          { id: "biogen_leqembi", name: "Biogen Leqembi", ticker: "BIIB", country: "US", role: "Lecanemab 抗 Aβ 抗體，與 Eisai 共同開發" },
          { id: "eisai", name: "Eisai", ticker: "4523.T", country: "JP", role: "Leqembi 主要開發者，與 Biogen 利潤分享" },
          { id: "roche_alz", name: "Roche Trontinemab", ticker: "RHHBY", country: "CH", role: "腦穿透抗體版本，gantenerumab 失敗後重啟開發" },
          { id: "novo_evoke_alz", name: "Novo Nordisk EVOKE", ticker: "NVO", country: "DK", role: "Semaglutide 評估阿茲海默症療效，2025-2026 解盲" },
        ],
        relationships: [
          "Lilly Kisunla 與 Biogen Leqembi 為僅有兩個獲批的抗 Aβ 抗體療法",
          "Kisunla 採可停藥設計，療程成本低於 Leqembi",
          "Roche 與 Novo 在差異化機制（腦穿透、GLP-1）尋求突破",
        ],
      },
      {
        id: "chronic-kidney",
        ...
        keyInfo: "CKD 用藥從降血壓延伸至 SGLT2、GLP-1、MRA，創造數百億美元新市場",
        marketType: "high_growth",
        companies: [
          { id: "bayer_kerendia", name: "Bayer Kerendia", ticker: "BAYN.DE", country: "DE", role: "Finerenone 非類固醇 MRA，糖尿病腎病標準療法" },
          { id: "az_farxiga_ckd", name: "AstraZeneca Farxiga (CKD)", ticker: "AZN", country: "UK", role: "SGLT2 抑制劑 CKD 適應症，DAPA-CKD 試驗陽性" },
          { id: "boehringer_jardi_ckd", name: "Boehringer Jardiance (CKD)", ticker: "", country: "DE", role: "SGLT2 抑制劑 EMPA-KIDNEY 試驗陽性，獲 CKD 適應症" },
          { id: "vertex_ckd", name: "Vertex Inaxaplin", ticker: "VRTX", country: "US", role: "APOL1 介導腎病小分子藥物，Phase 3 試驗中" },
          { id: "travere", name: "Travere Therapeutics", ticker: "TVTX", country: "US", role: "Filspari 治療 IgA 腎病，加速核可上市" },
        ],
        relationships: [
          "SGLT2 與 Finerenone 為 CKD 標準療法基石，可合併使用",
          "Vertex Inaxaplin 為首款針對基因型 APOL1 腎病的精準藥物",
          "Travere 在罕見腎病領域聚焦，與大廠走向差異化",
        ],
      },
      {
        id: "chronic-mash",
        name: "MASH 脂肪肝新藥",
        name_en: "MASH/NASH Liver Drugs",
        keyInfo: "MASH 為下一個千億美元慢性病市場，Rezdiffra 首個獲批藥物開啟序幕",
        marketType: "emerging",
        companies: [
          { id: "madrigal", name: "Madrigal Pharmaceuticals", ticker: "MDGL", country: "US", role: "Rezdiffra（resmetirom）首個獲批 MASH 藥物，THR-β 促效劑" },
          { id: "novo_mash", name: "Novo Nordisk Semaglutide", ticker: "NVO", country: "DK", role: "Phase 3 ESSENCE 試驗達標，預計 2025 年送件 MASH 適應症" },
          { id: "lilly_mash", name: "Eli Lilly Tirzepatide", ticker: "LLY", country: "US", role: "GLP-1/GIP 雙重促效劑 MASH 試驗中，數據領先" },
          { id: "akero", name: "Akero Therapeutics", ticker: "AKRO", country: "US", role: "Efruxifermin FGF21 類似物，肝纖維化逆轉數據領先" },
          { id: "896", name: "89bio", ticker: "ETNB", country: "US", role: "Pegozafermin FGF21 類似物，與 Akero 競爭" },
          { id: "viking_mash", name: "Viking VK2809", ticker: "VKTX", country: "US", role: "THR-β 促效劑 MASH 適應症，與 Madrigal 直接競爭" },
        ],
        relationships: [
          "Madrigal Rezdiffra 2024 年首個獲批 MASH 藥物，開啟商業化",
          "Novo 與 Lilly 以 GLP-1 跨入 MASH 市場，威脅 Madrigal 地位",
          "Akero 與 89bio FGF21 類似物為下一波 MASH 競爭主力",
        ],
      },
      {
        id: "chronic-rare-gene",
        name: "罕見疾病基因療法",
        name_en: "Rare Disease Gene Therapy",
        keyInfo: "Casgevy 為首個 CRISPR 基因編輯療法，治療鐮刀型貧血開啟基因醫學新紀元",
        marketType: "high_growth",
        companies: [
          { id: "vertex_casgevy", name: "Vertex Casgevy", ticker: "VRTX", country: "US", role: "CRISPR 基因編輯療法治療鐮刀型貧血與 β 地中海貧血，與 CRISPR Tx 共同開發" },
          { id: "crispr_tx", name: "CRISPR Therapeutics", ticker: "CRSP", country: "CH", role: "Casgevy 共同開發者，CRISPR-Cas9 技術領先" },
          { id: "bluebird", name: "bluebird bio", ticker: "BLUE", country: "US", role: "Lyfgenia 治療鐮刀型貧血基因療法，與 Casgevy 競爭" },
          { id: "biomarin", name: "BioMarin Roctavian", ticker: "BMRN", country: "US", role: "血友病 A 基因療法，AAV 載體技術" },
          { id: "sarepta", name: "Sarepta Therapeutics", ticker: "SRPT", country: "US", role: "Elevidys 治療裘馨氏肌肉失養症，基因療法" },
          { id: "intellia", name: "Intellia Therapeutics", ticker: "NTLA", country: "US", role: "體內 CRISPR 編輯療法開發者，TTR 澱粉樣變性領先" },
        ],
        relationships: [
          "Vertex/CRISPR Tx 與 bluebird 在鐮刀型貧血基因療法直接競爭",
          "Casgevy 為首個 CRISPR 療法，單次療程定價 220 萬美元",
          "Intellia 與 Editas 推進體內 CRISPR 編輯，挑戰體外療法成本",
        ],
      },
      {
        id: "chronic-inflammation",
        name: "慢性發炎與免疫調節",
        name_en: "Chronic Inflammation & Immunomodulation",
        keyInfo: "IL-23 抗體取代 TNF-α 成為乾癬與克隆氏症金標準，IL-17 在僵直性脊椎炎領先",
        marketType: "oligopoly",
        companies: [
          { id: "jnj_tremfya_il23", name: "J&J Tremfya", ticker: "JNJ", country: "US", role: "Guselkumab IL-23 抗體，乾癬與克隆氏症雙適應症" },
          { id: "abbvie_skyrizi", name: "AbbVie Skyrizi", ticker: "ABBV", country: "US", role: "Risankizumab IL-23 抗體，2025 年銷售額預計破 170 億美元" },
          { id: "lilly_taltz", name: "Eli Lilly Taltz", ticker: "LLY", country: "US", role: "Ixekizumab IL-17 抗體，乾癬與僵直性脊椎炎" },
          { id: "novartis_cosentyx", name: "Novartis Cosentyx", ticker: "NVS", country: "CH", role: "Secukinumab IL-17 抗體，IL-17 開創者地位" },
          { id: "ucb_bimzelx", name: "UCB Bimzelx", ticker: "UCB.BR", country: "BE", role: "Bimekizumab 雙重抑制 IL-17A/IL-17F，療效領先" },
          { id: "sanofi_dupixent", name: "Sanofi/Regeneron Dupixent", ticker: "SNY", country: "FR", role: "Dupilumab IL-4/IL-13 抗體，異位性皮膚炎與氣喘藥王" },
        ],
        relationships: [
          "AbbVie Skyrizi 與 J&J Tremfya 為 IL-23 雙雄，乾癬市場主導",
          "IL-17 三雄（NVS、Lilly、UCB）爭奪僵直性脊椎炎與乾癬市場",
          "Dupixent 為過敏與發炎藥王，Sanofi 與 Regeneron 共同銷售分潤",
        ],
      },
    ],
  },
  ...
  // ============================================================
  {
    ...
    category: "hl",
    name: "癌症新藥與精準醫療",
    name_en: "Cancer New Drugs & Precision Oncology",
    description:
      "從免疫檢查點抑制劑、ADC 抗體藥物複合體到 CAR-T 細胞療法與 mRNA 癌症疫苗，腫瘤治療進入個人化精準醫療新紀元，2030 年全球抗癌藥市場規模預估突破 4000 億美元。",
    icon: "🎗️",
    color: "#ec4899",
    flowSummary: "標靶治療 → 免疫療法 → ADC → CAR-T → mRNA 疫苗",
    sections: [
      {
        id: "cancer-checkpoint",
        name: "免疫檢查點抑制劑",
        name_en: "Immune Checkpoint Inhibitors",
        keyInfo: "Keytruda 為全球藥王，2025 年銷售額預估突破 320 億美元",
        marketType: "oligopoly",
        companies: [
          { id: "merck_keytruda", name: "Merck Keytruda", ticker: "MRK", country: "US", role: "Pembrolizumab PD-1 抑制劑，獲批適應症超過 40 個", marketShare: "~45%" },
          { id: "bms_opdivo", name: "BMS Opdivo", ticker: "BMY", country: "US", role: "Nivolumab PD-1 抑制劑，與 Yervoy 合併方案領先", marketShare: "~25%" },
          { id: "roche_tecentriq", name: "Roche Tecentriq", ticker: "RHHBY", country: "CH", role: "Atezolizumab PD-L1 抑制劑，肺癌與肝癌領先" },
          { id: "az_imfinzi", name: "AstraZeneca Imfinzi", ticker: "AZN", country: "UK", role: "Durvalumab PD-L1 抑制劑，肺癌與膀胱癌主力" },
          { id: "regeneron_libtayo", name: "Regeneron Libtayo", ticker: "REGN", country: "US", role: "Cemiplimab PD-1 抑制劑，皮膚鱗狀細胞癌領先" },
          { id: "akeso", name: "Akeso Cadonilimab", ticker: "9926.HK", country: "CN", role: "PD-1/CTLA-4 雙特異性抗體，中國領先業者" },
        ],
        relationships: [
          "Keytruda 與 Opdivo 雙寡占，合計佔 PD-1/PD-L1 全球市場 70%",
          "Merck Keytruda 2028 年專利到期前，生物相似藥已準備上市",
          "中國 Akeso 雙特異性抗體在跨國授權市場崛起，挑戰歐美龍頭",
        ],
      },
      {
        id: "cancer-adc",
        name: "ADC 抗體藥物複合體",
        name_en: "Antibody-Drug Conjugates",
        keyInfo: "ADC 為腫瘤學最熱賽道，Enhertu 銷售三年翻 5 倍突破 60 億美元",
        marketType: "high_growth",
        companies: [
          { id: "daiichi_enhertu", name: "Daiichi Sankyo Enhertu", ticker: "4568.T", country: "JP", role: "T-DXd HER2 ADC，與 AZ 共同開發，乳癌與胃癌領先" },
          { id: "az_enhertu", name: "AstraZeneca", ticker: "AZN", country: "UK", role: "Enhertu 共同行銷，全球商業化夥伴" },
          { id: "pfizer_padcev", name: "Pfizer Padcev", ticker: "PFE", country: "US", role: "Enfortumab vedotin Nectin-4 ADC，膀胱癌一線療法" },
          { id: "gilead_trodelvy", name: "Gilead Trodelvy", ticker: "GILD", country: "US", role: "Sacituzumab govitecan TROP2 ADC，三陰性乳癌領先" },
          { id: "immunogen", name: "ImmunoGen Elahere (AbbVie)", ticker: "ABBV", country: "US", role: "Mirvetuximab FRα ADC，AbbVie 以 101 億美元併購" },
          { id: "merck_adc", name: "Merck (Daiichi 合作)", ticker: "MRK", country: "US", role: "與 Daiichi 簽署 220 億美元 ADC 合作協議，獲三款管線" },
          { id: "rocket_adc", name: "Roche (Genentech)", ticker: "RHHBY", country: "CH", role: "Polivy CD79b ADC，淋巴瘤適應症" },
        ],
        relationships: [
          "Daiichi/AZ Enhertu 為 ADC 藥王，HER2 低表達適應症開啟新市場",
          "Pfizer 以 430 億美元併購 Seagen，取得 ADC 全方位佈局",
          "Merck 砸 220 億美元與 Daiichi 合作，補強後 Keytruda 時代管線",
        ],
      },
      {
        id: "cancer-cart",
        name: "CAR-T 細胞療法",
        name_en: "CAR-T Cell Therapy",
        keyInfo: "CAR-T 從血液癌症邁向實體腫瘤與自體免疫，全球已獲批 7 款療法",
        marketType: "high_growth",
        companies: [
          { id: "gilead_yescarta", name: "Gilead Yescarta/Tecartus", ticker: "GILD", country: "US", role: "Axi-cel CD19 CAR-T，淋巴瘤與白血病領先（併購 Kite）" },
          { id: "bms_breyanzi", name: "BMS Breyanzi/Abecma", ticker: "BMY", country: "US", role: "Liso-cel CD19 與 Ide-cel BCMA CAR-T，雙適應症佈局" },
          { id: "jnj_carvykti", name: "J&J Carvykti", ticker: "JNJ", country: "US", role: "Cilta-cel BCMA CAR-T，多發性骨髓瘤領先，與 Legend Biotech 共同開發" },
          { id: "legend", name: "Legend Biotech", ticker: "LEGN", country: "CN", role: "Carvykti 共同開發者，中國 CAR-T 領先企業" },
          { id: "novartis_kymriah", name: "Novartis Kymriah", ticker: "NVS", country: "CH", role: "Tisagenlecleucel CD19 CAR-T，首個獲批 CAR-T 療法" },
          { id: "autolus", name: "Autolus Aucatzyl", ticker: "AUTL", country: "UK", role: "Obecabtagene CD19 CAR-T，急性淋巴白血病" },
        ],
        relationships: [
          "Gilead、BMS、J&J 在 CAR-T 商業化領先，2025 年合計營收破 60 億美元",
          "J&J Carvykti 為多發性骨髓瘤金標準，與 BMS Abecma 直接競爭",
          "Legend Biotech 為中國 CAR-T 出海代表，與 J&J 利潤分享",
        ],
      },
      {
        id: "cancer-mrna",
        name: "mRNA 癌症疫苗",
        name_en: "mRNA Cancer Vaccines",
        keyInfo: "個人化 mRNA 癌症疫苗 2025-2026 多款 Phase 3 解盲，黑色素瘤領先突破",
        marketType: "emerging",
        companies: [
          { id: "moderna_mrna4157", name: "Moderna mRNA-4157", ticker: "MRNA", country: "US", role: "個人化新抗原 mRNA 疫苗，與 Merck 合作搭配 Keytruda" },
          { id: "merck_mrna_part", name: "Merck Keytruda 合作", ticker: "MRK", country: "US", role: "與 Moderna 合作 Phase 3，搭配 Keytruda 用於黑色素瘤" },
          { id: "biontech_bntx", name: "BioNTech", ticker: "BNTX", country: "DE", role: "個人化 mRNA 癌症疫苗 BNT122，與 Genentech 合作開發" },
          { id: "genentech_mrna", name: "Roche/Genentech", ticker: "RHHBY", country: "CH", role: "與 BioNTech 共同開發 mRNA 癌症疫苗" },
          { id: "curevac", name: "CureVac", ticker: "CVAC", country: "DE", role: "mRNA 平台技術，癌症疫苗早期開發" },
        ],
        relationships: [
          "Moderna/Merck 與 BioNTech/Roche 為 mRNA 癌症疫苗雙雄競賽",
          "個人化 mRNA 疫苗依賴 AI 預測新抗原，製造週期需縮短至 6 週內",
          "黑色素瘤 Phase 3 試驗為里程碑，預計 2025-2026 解盲決定產品方向",
        ],
      },
      {
        id: "cancer-til",
        name: "TIL 腫瘤浸潤淋巴球",
        name_en: "Tumor-Infiltrating Lymphocytes",
        keyInfo: "Amtagvi 為首個獲批 TIL 療法，治療晚期黑色素瘤開啟細胞療法新類別",
        marketType: "emerging",
        companies: [
          { id: "iovance", name: "Iovance Biotherapeutics", ticker: "IOVA", country: "US", role: "Amtagvi（lifileucel）首個獲批 TIL 療法，治療黑色素瘤" },
          { id: "instil", name: "Instil Bio", ticker: "TIL", country: "US", role: "TIL 療法開發者，多項實體腫瘤臨床" },
          { id: "achilles", name: "Achilles Therapeutics", ticker: "ACHL", country: "UK", role: "個人化 TIL 療法，新抗原靶向" },
          { id: "obsidian", name: "Obsidian Therapeutics", ticker: "", country: "US", role: "工程化 TIL 療法，私募階段" },
        ],
        relationships: [
          "Iovance Amtagvi 為首個獲批 TIL 療法，定價 51.5 萬美元",
          "TIL 療法製造週期長、成本高，限制大規模商業化",
          "個人化新抗原 TIL 療法為下一波創新方向",
        ],
      },
      {
        id: "cancer-protac",
        name: "PROTAC 蛋白降解劑",
        name_en: "PROTAC Protein Degraders",
        keyInfo: "PROTAC 突破傳統小分子限制，可降解非成藥蛋白，2026-2027 多款進入 Phase 3",
        marketType: "emerging",
        companies: [
          { id: "arvinas", name: "Arvinas Vepdegestrant", ticker: "ARVN", country: "US", role: "ER 降解劑 PROTAC，與 Pfizer 合作開發乳癌" },
          { id: "kymera", name: "Kymera Therapeutics", ticker: "KYMR", country: "US", role: "IRAK4、STAT3 降解劑開發者，與 Sanofi、Gilead 合作" },
          { id: "cgembio", name: "C4 Therapeutics", ticker: "CCCC", country: "US", role: "BCL6 與 BRAF 降解劑，腫瘤學佈局" },
          { id: "foghorn", name: "Foghorn Therapeutics", ticker: "FHTX", country: "US", role: "染色質調節蛋白降解劑，腫瘤學應用" },
          { id: "nurix", name: "Nurix Therapeutics", ticker: "NRIX", country: "US", role: "E3 連接酶降解劑平台，多項血液癌症臨床" },
          { id: "pfizer_protac", name: "Pfizer (Arvinas 合作)", ticker: "PFE", country: "US", role: "與 Arvinas 共同開發 Vepdegestrant，2024 年 Phase 3 數據陽性" },
        ],
        relationships: [
          "Arvinas/Pfizer Vepdegestrant 為首個進入 Phase 3 的 PROTAC，乳癌領先",
          "Kymera 與 Sanofi、Gilead 簽署超過 30 億美元授權合作",
          "PROTAC 平台技術授權熱絡，吸引大廠紛紛投入",
        ],
      },
      {
        id: "cancer-kras",
        name: "KRAS 抑制劑",
        name_en: "KRAS Inhibitors",
        keyInfo: "KRAS 為腫瘤學 40 年難以成藥標靶，2021 年 Lumakras 首破關，pan-KRAS 為下一波焦點",
        marketType: "high_growth",
        companies: [
          { id: "amgen_lumakras", name: "Amgen Lumakras", ticker: "AMGN", country: "US", role: "Sotorasib KRAS G12C 抑制劑，首個獲批 KRAS 藥物" },
          { id: "bms_krazati", name: "BMS Krazati", ticker: "BMY", country: "US", role: "Adagrasib KRAS G12C 抑制劑，併購 Mirati 取得" },
          { id: "revolution", name: "Revolution Medicines", ticker: "RVMD", country: "US", role: "Pan-KRAS 抑制劑開發者，涵蓋 G12D 等多突變型" },
          { id: "jnj_kras", name: "J&J（合作 Mirati 前管線）", ticker: "JNJ", country: "US", role: "KRAS G12D 抑制劑開發中" },
          { id: "boehringer_kras", name: "Boehringer Ingelheim", ticker: "", country: "DE", role: "BI-1701963 KRAS SOS1 抑制劑" },
        ],
        relationships: [
          "Amgen Lumakras 與 BMS Krazati 在 KRAS G12C 直接競爭",
          "BMS 以 48 億美元併購 Mirati 取得 Krazati 與 KRAS 管線",
          "Revolution Medicines 為 pan-KRAS 領跑者，挑戰 G12C 限制",
        ],
      },
      {
        id: "cancer-bispecific",
        name: "雙特異性抗體",
        name_en: "Bispecific Antibodies",
        keyInfo: "雙特異性抗體可同時結合腫瘤抗原與 T 細胞，現成療法挑戰 CAR-T 成本",
        marketType: "high_growth",
        companies: [
          { id: "roche_glofit", name: "Roche Glofitamab", ticker: "RHHBY", country: "CH", role: "CD20/CD3 雙抗，淋巴瘤適應症（Columvi）" },
          { id: "abbvie_epkinly", name: "AbbVie Epkinly", ticker: "ABBV", country: "US", role: "Epcoritamab CD20/CD3 雙抗，與 Genmab 共同開發" },
          { id: "genmab", name: "Genmab", ticker: "GMAB.CO", country: "DK", role: "雙特異性抗體技術平台，多項合作授權" },
          { id: "regeneron_bispec", name: "Regeneron Lynozyfic/Linvoseltamab", ticker: "REGN", country: "US", role: "BCMA/CD3 雙抗，多發性骨髓瘤適應症" },
          { id: "jnj_tecvayli", name: "J&J Tecvayli/Talvey", ticker: "JNJ", country: "US", role: "Teclistamab BCMA/CD3 與 Talquetamab GPRC5D/CD3 雙抗" },
          { id: "amgen_blincyto", name: "Amgen Blincyto", ticker: "AMGN", country: "US", role: "Blinatumomab CD19/CD3 雙抗，首個獲批 BiTE 藥物" },
        ],
        relationships: [
          "AbbVie/Genmab Epkinly 與 Roche Glofitamab 在淋巴瘤雙抗直接競爭",
          "J&J Tecvayli 與 Regeneron Linvoseltamab 在多發性骨髓瘤 BCMA 雙抗競爭",
          "雙抗為現成藥物（off-the-shelf），挑戰 CAR-T 客製化高成本",
        ],
      },
      {
        id: "cancer-radio",
        name: "放射性藥物",
        name_en: "Radioligand Therapy",
        keyInfo: "放射性藥物為腫瘤學新藍海，Pluvicto 銷售 2025 年突破 25 億美元",
        marketType: "emerging",
        companies: [
          { id: "novartis_pluvicto", name: "Novartis Pluvicto", ticker: "NVS", country: "CH", role: "Lu-177 PSMA-617 放射性配體療法，前列腺癌領先" },
          { id: "lantheus", name: "Lantheus Holdings", ticker: "LNTH", country: "US", role: "Pylarify PSMA PET 顯影劑，放射診療一體佈局" },
          { id: "telix", name: "Telix Pharmaceuticals", ticker: "TLX", country: "AU", role: "Illuccix PSMA PET 顯影劑，澳洲放射性藥物龍頭" },
          { id: "bms_radio", name: "BMS (RayzeBio)", ticker: "BMY", country: "US", role: "BMS 以 41 億美元併購 RayzeBio 切入 actinium-225 療法" },
          { id: "lilly_radio", name: "Eli Lilly (Point Biopharma)", ticker: "LLY", country: "US", role: "Lilly 以 14 億美元併購 Point Biopharma 取得放射性藥物管線" },
          { id: "az_radio", name: "AstraZeneca (Fusion Pharma)", ticker: "AZN", country: "UK", role: "AZ 以 20 億美元併購 Fusion，加入 actinium-225 賽道" },
        ],
        relationships: [
          "Novartis Pluvicto 為首個獲批 PSMA 放射性藥物，前列腺癌領先",
          "BMS、Lilly、AZ 紛紛併購進入放射性藥物賽道，actinium-225 為焦點",
          "Lantheus 與 Telix 在 PSMA PET 顯影劑直接競爭",
        ],
      },
      {
        id: "cancer-liquid-biopsy",
        name: "液態切片與早期篩檢",
        name_en: "Liquid Biopsy & Early Detection",
        keyInfo: "ctDNA 微小殘留病灶（MRD）監測為癌症治療典範轉移，早期多癌篩檢為長期願景",
        marketType: "high_growth",
        companies: [
          { id: "guardant", name: "Guardant Health", ticker: "GH", country: "US", role: "Guardant360 液態切片與 Shield 大腸癌篩檢，MRD 監測領先" },
          { id: "exact_sciences", name: "Exact Sciences Cologuard", ticker: "EXAS", country: "US", role: "Cologuard 大腸癌糞便檢測，OncodetectMRD 監測" },
          { id: "natera", name: "Natera Signatera", ticker: "NTRA", country: "US", role: "Signatera 個人化 MRD 監測，腫瘤學領先業者" },
          { id: "grail", name: "GRAIL Galleri", ticker: "GRAL", country: "US", role: "多癌早期篩檢（MCED），Illumina 分拆獨立" },
          { id: "illumina", name: "Illumina", ticker: "ILMN", country: "US", role: "次世代定序龍頭，提供液態切片底層技術" },
          { id: "tempus_lb", name: "Tempus AI", ticker: "TEM", country: "US", role: "AI 驅動腫瘤定序與 MRD 監測" },
        ],
        relationships: [
          "Guardant、Natera、Exact Sciences 在 MRD 監測市場直接競爭",
          "GRAIL Galleri 為首個多癌早期篩檢產品，需建立臨床效益證據",
          "Illumina 為液態切片底層定序平台供應商，所有業者皆依賴",
        ],
      },
      {
        id: "cancer-ai-drug",
        name: "AI 藥物發現",
        name_en: "AI Drug Discovery",
        keyInfo: "AI 製藥平台從靶點發現延伸至臨床試驗設計，與大藥廠簽署數十億美元合作",
        marketType: "emerging",
        companies: [
          { id: "recursion_rxrx", name: "Recursion Pharmaceuticals", ticker: "RXRX", country: "US", role: "圖像基礎 AI 藥物發現，與 Roche、Bayer 合作" },
          { id: "exscientia", name: "Exscientia (Recursion 併購)", ticker: "RXRX", country: "UK", role: "AI 分子設計平台，2024 年被 Recursion 併購" },
          { id: "schrodinger", name: "Schrödinger", ticker: "SDGR", country: "US", role: "物理基礎 AI 分子模擬，與多家藥廠合作" },
          { id: "absci", name: "Absci", ticker: "ABSI", country: "US", role: "生成式 AI 抗體設計平台" },
          { id: "relay_tx", name: "Relay Therapeutics", ticker: "RLAY", country: "US", role: "AI 蛋白質動力學設計，PI3Kα 抑制劑領先" },
          { id: "isomorphic", name: "Isomorphic Labs (Alphabet)", ticker: "GOOGL", country: "UK", role: "Alphabet 旗下 AI 製藥子公司，AlphaFold 衍生平台" },
        ],
        relationships: [
          "Recursion 2024 年併購 Exscientia 成為 AI 藥物發現最大上市公司",
          "Isomorphic Labs 為 Alphabet/DeepMind 衍生，與 Novartis、Lilly 簽 30 億美元合作",
          "Schrödinger 與 Relay 採物理模擬路線，與深度學習路線形成差異化",
        ],
      },
    ],
  },
  ...
  // ============================================================
  {
    ...
    category: "hl",
    name: "醫療器材與診斷",
    name_en: "Medical Devices & Diagnostics",
    description:
      "手術機器人、連續血糖監測、AI 影像診斷、心血管介入器材與居家檢測共同構成 5000 億美元醫療器材市場，技術門檻高、法規嚴格，形成寡占與創新並存格局。",
    icon: "🏥",
    color: "#f43f5e",
    flowSummary: "外科機器人 → 連續監測 → 影像診斷 → 居家檢測 → 數位治療",
    sections: [
      {
        id: "device-surgical-robot",
        name: "手術機器人",
        name_en: "Surgical Robotics",
        keyInfo: "Intuitive Surgical 手術機器人裝機量 2025 年突破 1 萬台，da Vinci 5 帶動換機潮",
        marketType: "oligopoly",
        companies: [
          { id: "intuitive", name: "Intuitive Surgical", ticker: "ISRG", country: "US", role: "da Vinci 系列手術機器人，全球軟組織手術機器人龍頭", marketShare: "~75%" },
          { id: "stryker_robot", name: "Stryker Mako", ticker: "SYK", country: "US", role: "Mako 骨科手術機器人，膝關節置換領先" },
          { id: "jnj_monarch", name: "J&J Monarch/Ottava", ticker: "JNJ", country: "US", role: "Monarch 支氣管鏡與 Ottava 軟組織手術機器人開發中" },
          { id: "medtronic_hugo", name: "Medtronic Hugo", ticker: "MDT", country: "US", role: "Hugo RAS 軟組織手術機器人，挑戰 Intuitive 地位" },
          { id: "zimmer_rosa", name: "Zimmer Biomet ROSA", ticker: "ZBH", country: "US", role: "ROSA 骨科手術機器人，與 Stryker Mako 直接競爭" },
          { id: "smith_n", name: "Smith+Nephew CORI", ticker: "SNN", country: "UK", role: "CORI 手持式骨科手術機器人，差異化定位" },
        ],
        relationships: [
          "Intuitive Surgical 壟斷軟組織手術機器人，市佔超過 75%",
          "J&J Ottava 與 Medtronic Hugo 試圖打破 Intuitive 壟斷",
          "Stryker Mako 與 Zimmer ROSA 在骨科手術機器人直接競爭",
        ],
      },
      {
        id: "device-cgm",
        name: "連續血糖監測 CGM",
        name_en: "Continuous Glucose Monitoring",
        keyInfo: "CGM 從糖尿病延伸至代謝健康消費者市場，2025 年全球出貨量突破 1 億顆",
        marketType: "oligopoly",
        companies: [
          { id: "dexcom", name: "Dexcom", ticker: "DXCM", country: "US", role: "G7 與 Stelo 連續血糖監測，精準度領先", marketShare: "~40%" },
          { id: "abbott_libre", name: "Abbott FreeStyle Libre", ticker: "ABT", country: "US", role: "Libre 3 連續血糖監測，全球出貨量最大", marketShare: "~50%" },
          { id: "medtronic_cgm", name: "Medtronic Guardian", ticker: "MDT", country: "US", role: "Guardian 4 CGM 整合胰島素幫浦閉環系統" },
          { id: "senseonics", name: "Senseonics Eversense", ticker: "SENS", country: "US", role: "植入式 CGM，使用週期 365 天" },
          { id: "tandem", name: "Tandem Diabetes Care", ticker: "TNDM", country: "US", role: "胰島素幫浦整合 Dexcom CGM 提供閉環系統" },
        ],
        relationships: [
          "Abbott Libre 與 Dexcom G7 雙寡占，合計佔全球 CGM 市場 90%",
          "Abbott Lingo 與 Dexcom Stelo 切入非糖尿病消費者代謝健康市場",
          "Medtronic Guardian 整合胰島素幫浦提供閉環療法，差異化定位",
        ],
      },
      {
        id: "device-cardiac-monitoring",
        name: "心律與心血管監測",
        name_en: "Cardiac Monitoring",
        keyInfo: "心律監測與心臟節律器市場 2025 年達 250 億美元，無導線節律器領先成長",
        marketType: "oligopoly",
        companies: [
          { id: "boston_sci", name: "Boston Scientific", ticker: "BSX", country: "US", role: "心臟節律器、除顫器與電生理導管領先業者" },
          { id: "medtronic_cardio", name: "Medtronic", ticker: "MDT", country: "US", role: "Micra 無導線節律器與 LINQ 植入式心律監測器" },
          { id: "abbott_cardio", name: "Abbott", ticker: "ABT", country: "US", role: "心臟節律器與 Confirm Rx 植入式心律監測器" },
          { id: "irhythm", name: "iRhythm Technologies", ticker: "IRTC", country: "US", role: "Zio 貼片式心律監測，門診心電圖領先" },
          { id: "biotronik", name: "Biotronik", ticker: "", country: "DE", role: "心臟節律器歐洲領先業者" },
        ],
        relationships: [
          "Boston Scientific、Medtronic、Abbott 三雄寡占心臟節律器市場",
          "Medtronic Micra 與 Abbott Aveir 在無導線節律器直接競爭",
          "iRhythm 以貼片式 Zio 顛覆傳統 Holter 心電圖檢測",
        ],
      },
      {
        id: "device-ai-imaging",
        name: "AI 影像診斷",
        name_en: "AI Medical Imaging",
        keyInfo: "FDA 已批准超過 900 款 AI 醫療器材，AI 影像診斷滲透率快速提升",
        marketType: "high_growth",
        companies: [
          { id: "tempus_ai", name: "Tempus AI", ticker: "TEM", country: "US", role: "AI 驅動腫瘤定序與分子診斷，臨床數據平台領先" },
          { id: "veracyte", name: "Veracyte", ticker: "VCYT", country: "US", role: "AI 基因組分類診斷，甲狀腺與肺癌領先" },
          { id: "siemens_health", name: "Siemens Healthineers", ticker: "SHL.DE", country: "DE", role: "AI Rad Companion 與影像 AI 平台" },
          { id: "ge_health", name: "GE HealthCare", ticker: "GEHC", country: "US", role: "Edison 醫療 AI 平台，影像診斷與分析" },
          { id: "philips_health", name: "Philips Healthcare", ticker: "PHG", country: "NL", role: "整合 AI 影像診斷工作流程" },
          { id: "viz_ai", name: "Viz.ai", ticker: "", country: "US", role: "AI 中風偵測平台，私募階段獨角獸" },
        ],
        relationships: [
          "Siemens、GE、Philips 三雄寡占大型影像設備整合 AI 功能",
          "Tempus AI 與 Veracyte 聚焦分子診斷 AI，差異化定位",
          "AI 影像新創與大廠平台合作分潤，加速臨床滲透",
        ],
      },
      {
        id: "device-tavr",
        name: "心血管介入器材 TAVR/MitraClip",
        name_en: "TAVR & Structural Heart",
        keyInfo: "經導管主動脈瓣置換（TAVR）2025 年市場規模 70 億美元，二尖瓣修補快速成長",
        marketType: "oligopoly",
        companies: [
          { id: "edwards", name: "Edwards Lifesciences", ticker: "EW", country: "US", role: "Sapien TAVR 領先業者，PASCAL 二尖瓣修補系統", marketShare: "~60%" },
          { id: "medtronic_tavr", name: "Medtronic Evolut", ticker: "MDT", country: "US", role: "Evolut TAVR 系統，與 Edwards 直接競爭" },
          { id: "abbott_mitra", name: "Abbott MitraClip", ticker: "ABT", country: "US", role: "MitraClip 二尖瓣修補系統，全球領先" },
          { id: "boston_watchman", name: "Boston Scientific Watchman", ticker: "BSX", country: "US", role: "Watchman 左心耳封堵器，預防中風領先" },
        ],
        relationships: [
          "Edwards Lifesciences 在 TAVR 市場領先，Medtronic Evolut 為主要競爭對手",
          "Abbott MitraClip 與 Edwards PASCAL 在二尖瓣修補直接競爭",
          "結構性心臟病介入器材為心臟介入治療新藍海",
        ],
      },
      {
        id: "device-d2c-telehealth",
        name: "居家檢測與遠距醫療",
        name_en: "DTC Home Testing & Telehealth",
        keyInfo: "GLP-1 與 D2C 慢性病管理推升遠距醫療營收，2025 年市場規模突破 500 億美元",
        marketType: "emerging",
        companies: [
          { id: "hims_device", name: "Hims & Hers Health", ticker: "HIMS", country: "US", role: "D2C 慢性病與減重平台，個人化處方領先" },
          { id: "teladoc", name: "Teladoc Health", ticker: "TDOC", country: "US", role: "遠距醫療領先業者，整合慢性病管理" },
          { id: "lifestance", name: "LifeStance Health", ticker: "LFST", country: "US", role: "心理健康遠距醫療平台" },
          { id: "ginger_headspace", name: "Headspace Health", ticker: "", country: "US", role: "心理健康 App 與遠距諮商整合" },
          { id: "everly", name: "Everly Health", ticker: "", country: "US", role: "居家檢測套組，私募階段獨角獸" },
          { id: "amwell", name: "American Well", ticker: "AMWL", country: "US", role: "醫院端遠距醫療平台供應商" },
        ],
        relationships: [
          "Hims 與 Ro 為 D2C 慢性病處方雙雄，與大藥廠直接配送競爭",
          "Teladoc 自 2021 高點後股價下跌 90%，獲利模式持續調整",
          "心理健康遠距醫療為疫情後成長最快子領域",
        ],
      },
      {
        id: "device-ivd",
        name: "體外診斷 IVD",
        name_en: "In Vitro Diagnostics",
        keyInfo: "全球 IVD 市場 2025 年規模 1200 億美元，分子診斷與伴隨診斷成長最快",
        marketType: "oligopoly",
        companies: [
          { id: "roche_dx", name: "Roche Diagnostics", ticker: "RHHBY", country: "CH", role: "全球 IVD 龍頭，分子診斷與免疫分析", marketShare: "~20%" },
          { id: "abbott_dx", name: "Abbott Diagnostics", ticker: "ABT", country: "US", role: "Alinity 系統整合 IVD 解決方案" },
          { id: "danaher", name: "Danaher (Beckman/Cepheid)", ticker: "DHR", country: "US", role: "旗下 Beckman Coulter、Cepheid 與 Leica 構成 IVD 平台" },
          { id: "thermo_fisher", name: "Thermo Fisher Scientific", ticker: "TMO", country: "US", role: "生命科學工具與臨床診斷整合" },
          { id: "siemens_dx", name: "Siemens Healthineers Diagnostics", ticker: "SHL.DE", country: "DE", role: "Atellica 系統整合臨床化學與免疫分析" },
          { id: "qiagen", name: "QIAGEN", ticker: "QGEN", country: "DE", role: "分子診斷樣本前處理與伴隨診斷" },
        ],
        relationships: [
          "Roche、Abbott、Danaher、Siemens 四雄寡占全球 IVD 市場",
          "Danaher 透過併購 Cepheid、Beckman 建立多元 IVD 平台",
          "QIAGEN 在樣本前處理與伴隨診斷具利基定位",
        ],
      },
      {
        id: "device-digital-tx",
        name: "數位治療",
        name_en: "Digital Therapeutics",
        keyInfo: "數位治療商業模式仍在驗證，FDA 批准產品需面對保險給付挑戰",
        marketType: "emerging",
        companies: [
          { id: "akili", name: "Akili Interactive", ticker: "AKLI", country: "US", role: "EndeavorRx 注意力不足過動症數位治療，遊戲化處方" },
          { id: "click_tx", name: "Click Therapeutics", ticker: "", country: "US", role: "處方數位治療平台，與大藥廠合作開發" },
          { id: "pear", name: "Pear Therapeutics", ticker: "", country: "US", role: "成癮數位治療開發者，2023 年破產，行業警鐘" },
          { id: "dario", name: "DarioHealth", ticker: "DRIO", country: "US", role: "整合慢性病數位治療與遠距監測" },
          { id: "omada", name: "Omada Health", ticker: "OMDA", country: "US", role: "糖尿病與肥胖數位治療，企業端銷售模式" },
        ],
        relationships: [
          "Pear Therapeutics 2023 年破產為數位治療產業警鐘",
          "Akili 與 Click 持續推動 FDA 批准處方數位治療商業化",
          "數位治療給付仍是商業化最大瓶頸，企業端 B2B 模式較成功",
        ],
      },
      {
        id: "device-wearable",
        name: "穿戴式長期監測",
        name_en: "Wearable Continuous Monitoring",
        keyInfo: "Apple Watch 與消費級穿戴裝置切入醫療市場，FDA 批准心律監測功能",
        marketType: "high_growth",
        companies: [
          { id: "apple_health", name: "Apple Watch", ticker: "AAPL", country: "US", role: "ECG、血氧、跌倒偵測等醫療級功能，全球穿戴龍頭" },
          { id: "whoop", name: "Whoop (private)", ticker: "", country: "US", role: "訂閱制運動與健康監測手環" },
          { id: "oura", name: "Oura Ring (private)", ticker: "", country: "FI", role: "睡眠與恢復追蹤戒指，獨角獸新創" },
          { id: "garmin", name: "Garmin", ticker: "GRMN", country: "US", role: "運動穿戴與健康監測手錶" },
          { id: "fitbit_google", name: "Fitbit (Google)", ticker: "GOOGL", country: "US", role: "Google 子品牌穿戴裝置，整合 Pixel Watch" },
          { id: "samsung_health", name: "Samsung Galaxy Watch", ticker: "005930.KS", country: "KR", role: "Galaxy Watch 整合 ECG 與血壓監測" },
        ],
        relationships: [
          "Apple Watch 為穿戴式醫療領導者，FDA 批准多項心律監測功能",
          "Oura Ring 與 Whoop 採訂閱制差異化商業模式",
          "穿戴裝置正逐步整合 CGM 等醫療級感測器，挑戰傳統醫材",
        ],
      },
    ],
  },
  // ============================================================
  // hl/gene_therapy — 🧬 基因編輯與細胞療法
  // ============================================================
  {
    id: "gene_therapy",
    slug: "gene_therapy",
    category: "hl",
    name: "基因編輯與細胞療法",
    name_en: "Gene Editing & Cell Therapy",
    description:
      "從 CRISPR 基因編輯到 CAR-T 細胞療法，治癒級療法正改變罕見病、癌症與遺傳疾病的治療典範。",
    icon: "🧬",
    color: "#7c3aed",
    flowSummary: "DNA 編輯 → 細胞工程 → 體外擴增 → 患者回輸 → 長期追蹤",
    sections: [
      {
        id: "gene-crispr",
        name: "CRISPR 基因編輯療法",
        name_en: "CRISPR Gene Editing Therapy",
        keyInfo: "Casgevy (鐮刀型紅血球症) 2023 獲 FDA 核准，每劑定價 220 萬美元",
        marketType: "oligopoly",
        companies: [
          { id: "crispr_tx", name: "CRISPR Therapeutics", ticker: "CRSP", country: "CH", role: "Casgevy 共同開發者，與 Vertex 合作", marketShare: "Casgevy 共享", howTo: "Casgevy 用於 12 歲以上鐮刀型紅血球症與輸血依賴型 β 地中海貧血。需至 FDA 認證的授權治療中心 (ATC) 進行，過程包含幹細胞採集、體外 CRISPR 編輯、清髓性化療與細胞回輸。", frequency: "一次性療法（單次回輸後長期追蹤 15 年）", notes: "全程治療期約 6-12 個月，包含清髓化療副作用（不孕、感染風險、二次癌症）。美國定價 220 萬美元，台灣尚未引進。需排除懷孕、活動性感染。" },
          { id: "intellia", name: "Intellia Therapeutics", ticker: "NTLA", country: "US", role: "in-vivo CRISPR 領導者，治療 ATTR 澱粉樣變性病", howTo: "NTLA-2001 (nex-z) 針對 ATTR 心肌病變與多發性神經病變，採用 LNP 脂質奈米粒子直接遞送 CRISPR 至肝臟，無需體外操作。第三期臨床試驗 MAGNITUDE 進行中。", frequency: "單次靜脈注射，預期長效作用", notes: "尚未獲批，預計 2026-2027 上市。in-vivo 遞送相較於體外編輯成本可降至 1/10。需監測肝功能與免疫反應。對 LNP 過敏者禁用。" },
          { id: "vertex_pharma", name: "Vertex Pharmaceuticals", ticker: "VRTX", country: "US", role: "與 CRISPR Tx 共同商業化 Casgevy", marketShare: "Casgevy 共享", howTo: "Vertex 負責 Casgevy 的全球商業化與生產，患者透過授權治療中心申請。同時開發囊性纖維化、第一型糖尿病細胞療法等管線。", frequency: "Casgevy 為一次性療法", notes: "Vertex 在罕見病與細胞療法布局深，營收主力仍為囊腫性纖維化 Trikafta。第一型糖尿病 VX-880 已展現停胰島素效果。" },
          { id: "editas", name: "Editas Medicine", ticker: "EDIT", country: "US", role: "CRISPR/Cas9 與 Cas12a 雙平台", howTo: "Reni-cel (EDIT-301) 針對鐮刀型紅血球症與 β 地中海貧血，使用 Cas12a 編輯 HBG1/HBG2 啟動子。第一/二期臨床試驗 RUBY/EdiTHAL 進行中。", frequency: "一次性療法（臨床試驗階段）", notes: "Cas12a 相較 Cas9 有更高精準度與更小蛋白，可能降低脫靶率。2024 失去 Casgevy 共同開發地位後股價承壓。" },
          { id: "beam", name: "Beam Therapeutics", ticker: "BEAM", country: "US", role: "鹼基編輯先驅，無雙股斷裂風險", howTo: "BEAM-101 鹼基編輯治療鐮刀型紅血球症，可精準轉換單一鹼基（C→T 或 A→G）而不切斷 DNA 雙股，降低基因組不穩定風險。第一/二期 BEACON 試驗進行中。", frequency: "一次性療法（臨床試驗階段）", notes: "鹼基編輯精準度提升 100 倍，但僅能做四種特定鹼基轉換。需配合清髓性化療。Verve 心血管管線同樣使用 Beam 鹼基編輯技術。" },
        ],
        relationships: [
          "CRISPR Tx 與 Vertex 共同擁有 Casgevy，為首個獲批 CRISPR 療法",
          "Intellia 領導 in-vivo CRISPR，可大幅降低治療成本",
          "Beam、Verve 採用鹼基編輯，較傳統 CRISPR 精準度更高",
        ],
      },
      {
        id: "gene-cart",
        name: "CAR-T 細胞療法",
        name_en: "CAR-T Cell Therapy",
        keyInfo: "CAR-T 治療血癌完全緩解率 70-90%，全球銷售年增 30%",
        marketType: "oligopoly",
        companies: [
          { id: "gilead_cart", name: "Gilead Sciences (Kite)", ticker: "GILD", country: "US", role: "Yescarta + Tecartus 領導", marketShare: "~40% CD19 CAR-T", howTo: "Yescarta 用於復發/難治大 B 細胞淋巴瘤、濾泡性淋巴瘤；Tecartus 用於套細胞淋巴瘤、ALL。患者需至全球 600+ 認證治療中心，採集 T 細胞後送 Kite 工廠製造 14-17 天後回輸。", frequency: "一次性療法（單次回輸）", notes: "全球售價約 37.3-42.4 萬美元。常見嚴重副作用：細胞激素風暴 (CRS)、神經毒性 (ICANS) 需住院監測。台灣健保 2024 起部分給付。" },
          { id: "bms_cart", name: "Bristol Myers Squibb", ticker: "BMY", country: "US", role: "Breyanzi + Abecma 雙明星", marketShare: "~30%", howTo: "Breyanzi (liso-cel) 治療大 B 細胞淋巴瘤、CLL/SLL；Abecma (ide-cel) 治療多發性骨髓瘤 BCMA。Breyanzi 較 Yescarta CRS 發生率較低，可於門診管理。", frequency: "一次性療法（單次回輸）", notes: "Breyanzi 美國售價 41 萬美元。BMY 2024 因 Abecma 銷售衰退與 J&J Carvykti 競爭壓力承壓。需排除中樞神經病變、活動性感染。" },
          { id: "jnj_cart", name: "Johnson & Johnson", ticker: "JNJ", country: "US", role: "Carvykti (與 Legend 合作) BCMA 領導", howTo: "Carvykti (cilta-cel) 治療復發/難治多發性骨髓瘤，2024 FDA 擴大至二線適應症。為雙抗原結合 BCMA CAR-T，療效深度高於 Abecma。需至認證中心進行單採與回輸。", frequency: "一次性療法（單次回輸）", notes: "美國售價 46.5 萬美元。CARTITUDE-4 研究中位無進展存活期 33.2 個月。神經毒性與運動障礙（帕金森樣症狀）為特殊副作用。" },
          { id: "novartis_cart", name: "Novartis", ticker: "NVS", country: "CH", role: "Kymriah 首個獲批 CAR-T", howTo: "Kymriah (tisa-cel) 為 2017 首個獲批 CAR-T，治療 25 歲以下 B-ALL 與大 B 細胞淋巴瘤。Novartis 於賓州大學 Carl June 實驗室技轉。", frequency: "一次性療法（單次回輸）", notes: "Kymriah 售價 47.5 萬美元（兒童 ALL）。生產良率與後進者競爭使市佔下滑。台灣食藥署 2021 核准，部分自費。" },
          { id: "legend_bio", name: "Legend Biotech", ticker: "LEGN", country: "CN", role: "Carvykti 開發者，與 JNJ 合作", howTo: "Legend 為 Carvykti 原研單位，與 JNJ 五五分潤合作。同時開發實體瘤 CAR-T (DLL3、GPRC5D) 與通用型 CAR-T 管線。中國總部，美國納斯達克上市。", frequency: "Carvykti 為一次性療法", notes: "Legend 為金斯瑞生物科技 (GenScript) 旗下，享中美雙重生物科技優勢。Carvykti 2024 全年銷售 9.6 億美元，年增 93%。" },
        ],
        relationships: [
          "Gilead、BMS、J&J 三巨頭合計掌握全球 90%+ 商業化 CAR-T 市場",
          "Carvykti 與 Abecma 在 BCMA 多發性骨髓瘤領域正面競爭",
          "Legend 為中國 CAR-T 走向全球的代表，與 JNJ 五五分潤",
        ],
      },
      {
        id: "gene-next-cart",
        name: "體內 CAR-T 與下一代細胞療法",
        name_en: "In-vivo CAR-T & Next-Gen Cell Therapy",
        keyInfo: "in-vivo CAR-T 不需體外擴增，可大幅降低治療成本至 1/10",
        marketType: "emerging",
        companies: [
          { id: "arcellx", name: "Arcellx", ticker: "ACLX", country: "US", role: "與 Gilead 合作 anito-cel BCMA 療法", howTo: "Anito-cel (anitocabtagene autoleucel) 為新一代 BCMA CAR-T，使用合成 D-domain 結合域取代傳統 scFv，目標降低免疫原性與神經毒性。iMMagine-1 第二期試驗中，全反應率 97%。", frequency: "臨床試驗階段，一次性療法", notes: "與 Gilead/Kite 簽 32.5 億美元合作，2024 BLA 申請進行中。預期 2025 下半年獲批，挑戰 Carvykti 與 Abecma 地位。" },
          { id: "caribou", name: "Caribou Biosciences", ticker: "CRBU", country: "US", role: "現貨型 (allogeneic) CAR-T", howTo: "CB-010 為現貨型抗 CD19 CAR-T，從健康捐贈者 T 細胞製造，使用 chRDNA CRISPR 技術編輯 TRAC、B2M、PD-1 三基因。患者無需等待體外製造，當天可治療。", frequency: "臨床試驗階段，可能多次給藥", notes: "現貨型 CAR-T 解決自體療法 14-17 天等待期與高成本問題。挑戰在於同種異體免疫排斥導致細胞持久性短。共同創辦人 Jennifer Doudna 為諾貝爾化學獎得主。" },
          { id: "umoja", name: "Umoja Biopharma (Private)", ticker: "Private", country: "US", role: "in-vivo CAR-T 先驅", howTo: "VivoVec 平台採用病毒載體將 CAR 基因直接遞送至患者體內 T 細胞，無需體外採集、編輯、擴增。理論上可將 CAR-T 製造成本從 50 萬美元降至 5 萬美元。", frequency: "臨床試驗階段 (UB-VV111 第一期)", notes: "Private 未上市，最新 D 輪募資 1 億美元。in-vivo 路線同時還有 Capstan、Orna、Sana 等競爭者。安全性挑戰在於體內 T 細胞編輯的精準控制。" },
        ],
        relationships: [
          "Arcellx 為 Gilead/Kite 戰略夥伴，準備挑戰 BCMA CAR-T 市場",
          "Caribou 與 Allogene、Cellectis 同為現貨型 CAR-T 三巨頭",
          "Umoja 為 in-vivo CAR-T 路線代表，目標破壞傳統自體 CAR-T 商業模式",
        ],
      },
      {
        id: "gene-til",
        name: "TIL 腫瘤浸潤淋巴球療法",
        name_en: "TIL Tumor-Infiltrating Lymphocytes",
        keyInfo: "Iovance Amtagvi 2024 獲批，首個實體瘤細胞療法",
        marketType: "emerging",
        companies: [
          { id: "iovance", name: "Iovance Biotherapeutics", ticker: "IOVA", country: "US", role: "Amtagvi 黑色素瘤療法，首個實體瘤細胞療法", howTo: "Amtagvi (lifileucel) 用於 PD-1 抑制劑治療後仍進展的不可切除/轉移性黑色素瘤。需手術切除腫瘤組織，分離 TIL 並於 GMP 工廠擴增 22 天，回輸後加 IL-2 維持。", frequency: "一次性療法（單次回輸後 IL-2 維持）", notes: "美國售價 51.5 萬美元。需先清淋化療與後續 IL-2 刺激，副作用包含血小板低下、貧血、發燒、低血壓。客觀反應率約 31%。台灣尚未引進。" },
          { id: "instil", name: "Instil Bio", ticker: "TIL", country: "US", role: "TIL 平台與 CoStAR 技術", howTo: "ITIL-168 為 TIL 候選療法，CoStAR (co-stimulatory antigen receptor) 平台改造 TIL 細胞辨識 HLA-A*02 + cMET 雙標記，提升實體瘤反應。第一期試驗評估膽道癌、肺癌。", frequency: "臨床試驗階段", notes: "Instil 2023 大幅重組，停止英國設廠並聚焦工程化 TIL 平台 (ITIL-306)。市值僅 1 億美元，為高風險小型生技股。" },
        ],
        relationships: [
          "Iovance 為實體瘤細胞療法先驅，Amtagvi 開啟非血液腫瘤新時代",
          "TIL 製造流程比 CAR-T 更複雜，需個別腫瘤組織與長時間擴增",
          "Instil 工程化 TIL 路線探索固體腫瘤抗原特異性挑戰",
        ],
      },
      {
        id: "gene-aav",
        name: "體內基因療法 (Gene Therapy)",
        name_en: "In-vivo Gene Therapy",
        keyInfo: "AAV 病毒載體一次治療可達 10 年以上療效",
        marketType: "high_growth",
        companies: [
          { id: "bluebird", name: "bluebird bio", ticker: "BLUE", country: "US", role: "Skysona, Lyfgenia, Zynteglo 三大基因療法", howTo: "Lyfgenia 治療鐮刀型紅血球症（與 Casgevy 競爭）；Zynteglo 治療 β 地中海貧血；Skysona 治療腦腎上腺白質失養症。皆採離體 lentivirus 載體將基因送入造血幹細胞後回輸。", frequency: "一次性療法（單次回輸）", notes: "Lyfgenia 售價 310 萬美元，Casgevy 220 萬美元。Skysona 因白血病風險被標黑框警告。bluebird 2024 持續虧損，財務狀況岌岌可危。" },
          { id: "sarepta", name: "Sarepta Therapeutics", ticker: "SRPT", country: "US", role: "Elevidys (杜興氏肌肉失養症)", howTo: "Elevidys (delandistrogene moxeparvovec) 為單次靜脈注射 AAV 基因療法，遞送縮短版 micro-dystrophin 基因。2024 擴大適應症至 4 歲以上所有 DMD 患者，無論是否仍可行走。", frequency: "一次性靜脈注射", notes: "美國售價 320 萬美元，全球最貴藥物之一。EMBARK 第三期未達主要終點但功能改善獲 FDA 認可。副作用包含肝損傷、心肌炎、橫紋肌溶解。AAV 抗體陽性者不適用。" },
          { id: "regenxbio", name: "Regenxbio", ticker: "RGNX", country: "US", role: "NAV AAV 平台授權", howTo: "Regenxbio 不直接賣藥，主要授權 NAV AAV8、AAV9 病毒載體技術，從 Sarepta Elevidys、Abeona ZEVASKYN、Novartis Zolgensma 收權利金。自有管線 ABBV-RGX-314 (濕性 AMD) 第三期試驗中。", frequency: "權利金商業模式", notes: "NAV 平台覆蓋全球大部分 AAV 基因療法，授權金穩定。與 AbbVie 合作眼科基因療法為下一個成長動能。" },
        ],
        relationships: [
          "bluebird、Sarepta 為實際商業化基因療法的領導者",
          "Regenxbio AAV 平台授權支持多項已批與管線基因療法",
          "AAV 載體免疫原性與遞送容量限制為基因療法核心挑戰",
        ],
      },
      {
        id: "gene-base-editing",
        name: "鹼基編輯與表觀遺傳",
        name_en: "Base Editing & Epigenetic Editing",
        keyInfo: "Base editing 與 prime editing 為 CRISPR 升級版，精準度提升 100 倍",
        marketType: "emerging",
        companies: [
          { id: "prime_med", name: "Prime Medicine", ticker: "PRME", country: "US", role: "Prime editing 領導者", howTo: "Prime editing 可進行所有 12 種點突變、小片段插入與缺失，無需 DNA 雙股斷裂。PM359 治療慢性肉芽腫病為首個臨床候選，2024 首位患者給藥。", frequency: "一次性療法（臨床試驗階段）", notes: "Prime editing 理論上可治療 90% 已知致病突變，但遞送效率與細胞特異性仍需優化。Prime 與 Broad Institute David Liu 實驗室共同開發。" },
          { id: "verve", name: "Verve Therapeutics", ticker: "VERV", country: "US", role: "心血管基因編輯，永久降 LDL", howTo: "VERVE-102 為 in-vivo 鹼基編輯療法，使用 LNP 遞送至肝臟編輯 PCSK9 基因關閉表達，永久降低 LDL 膽固醇。針對家族性高膽固醇血症與高心血管風險患者。", frequency: "單次靜脈注射，效果終身", notes: "2023 首位患者治療後 LDL 降 55%，效果維持 1 年以上。2024 與 Eli Lilly 簽 6 億美元合作。風險：終身改變基因不可逆，需謹慎評估長期安全性。" },
          { id: "tune_tx", name: "Tune Therapeutics (Private)", ticker: "Private", country: "US", role: "表觀遺傳沉默基因", howTo: "TEMPO 平台不改變 DNA 序列，而是透過甲基化等表觀遺傳修飾沉默或激活特定基因。Tune-401 治療慢性 B 肝為首個臨床候選，2024 進入第一期試驗。", frequency: "臨床試驗階段", notes: "表觀遺傳編輯理論上可逆且不留 DNA 序列改變，安全性可能優於 CRISPR。共同創辦人 Charles Gersbach 為杜克大學基因編輯權威。" },
        ],
        relationships: [
          "Prime Medicine、Beam Therapeutics 引領下一代精準編輯技術",
          "Verve 將鹼基編輯導入慢性病領域，挑戰傳統 PCSK9 抑制劑",
          "Tune 表觀遺傳路線提供不改 DNA 的可逆基因調控方案",
        ],
      },
      {
        id: "gene-manufacturing",
        name: "製造與供應鏈",
        name_en: "Manufacturing & Supply Chain",
        keyInfo: "細胞療法需 CGT CDMO，全球產能 < 50 個 facility",
        marketType: "oligopoly",
        companies: [
          { id: "lonza_cgt", name: "Lonza CGT", ticker: "LONN.SW", country: "CH", role: "全球最大 CGT CDMO", howTo: "Lonza 為瑞士 CDMO 巨頭，全球 7 個 CGT 製造廠（美國 Portsmouth、新加坡、瑞士、荷蘭），提供從病毒載體、細胞療法到 mRNA 全方位委託製造。", frequency: "CDMO 商業模式", notes: "Lonza 2024 收購 Roche Genentech 加州 Vacaville 廠，擴大生物製劑產能。Moderna mRNA 疫苗早期主要製造商。台廠保瑞、台耀為亞洲競爭者。" },
          { id: "catalent_cgt", name: "Catalent (Novo)", ticker: "Private", country: "US", role: "Novo 收購後成最大 GLP-1 + CGT", howTo: "Catalent 2024 被 Novo Holdings 以 165 億美元收購，三大廠（Indiana、Belgium、Italy）轉移 Novo Nordisk 製造 Ozempic、Wegovy。CGT 業務維持服務外部客戶。", frequency: "CDMO 商業模式", notes: "Novo 收購引發 GLP-1 競爭對手 (Eli Lilly) 擔憂供應集中。CGT 部門製造 J&J Carvykti、Sarepta Elevidys 等關鍵療法。" },
          { id: "samsung_bio", name: "Samsung Biologics", ticker: "207940.KS", country: "KR", role: "全球最大生物製劑 CDMO", howTo: "Samsung Bio 仁川松島園區為全球最大生物製劑廠（年產能 78.4 萬升），第五廠 2025 啟用後達 132 萬升。服務 BMS、Pfizer、Eli Lilly、Roche 等 30+ 大藥廠。", frequency: "CDMO 商業模式", notes: "Samsung Bio 2024 營收 4.5 兆韓元（約 33 億美元），毛利率超過 40%。子公司 Samsung Bioepis 開發生物相似藥。第六廠規劃中。" },
        ],
        relationships: [
          "Lonza、Catalent、Samsung Bio 為全球生物製劑 CDMO 三強",
          "CGT 製造產能稀缺為細胞與基因療法商業化最大瓶頸",
          "Novo 收購 Catalent 引發供應鏈集中化擔憂",
        ],
      },
    ],
  },
  // ============================================================
  // hl/ai_drug_discovery — 🤖 AI 藥物發現
  // ============================================================
  {
    id: "ai_drug_discovery",
    slug: "ai_drug_discovery",
    category: "hl",
    name: "AI 藥物發現",
    name_en: "AI Drug Discovery",
    description:
      "AI 加速藥物發現流程，從蛋白質結構預測到分子設計，將傳統 10 年研發週期縮短至 3-5 年。",
    icon: "🤖",
    color: "#06b6d4",
    flowSummary: "蛋白質結構 → 標靶識別 → 分子設計 → 模擬篩選 → 臨床驗證",
    sections: [
      {
        id: "ai-protein-structure",
        name: "蛋白質結構預測",
        name_en: "Protein Structure Prediction",
        keyInfo: "AlphaFold 3 預測精度達 80%+，覆蓋 2 億+ 蛋白質結構",
        marketType: "monopoly",
        companies: [
          { id: "alphabet_ai", name: "Alphabet (DeepMind)", ticker: "GOOGL", country: "US", role: "AlphaFold + Isomorphic Labs 藥物設計", howTo: "AlphaFold 3 (2024) 開放免費學術使用 AlphaFold Server，可預測蛋白質-小分子-核酸複合結構。商業使用需透過 Isomorphic Labs。", notes: "AlphaFold 2 創辦人 Demis Hassabis 與 John Jumper 獲 2024 諾貝爾化學獎。AlphaFold 3 大幅擴展應用至藥物設計與標靶評估。" },
          { id: "iso_labs", name: "Isomorphic Labs (Alphabet)", ticker: "GOOGL", country: "UK", role: "Alphabet 旗下 AI 藥物公司，與 Novartis/Lilly 合作", howTo: "Isomorphic Labs 結合 AlphaFold 與分子模擬，提供藥物設計平台給合作大藥廠。2024 與 Novartis 簽 12 億美元、Eli Lilly 簽 17 億美元合作。", notes: "Demis Hassabis 同任 DeepMind 與 Isomorphic Labs CEO。商業策略為與 Big Pharma 合作而非自主推進藥物管線。" },
          { id: "schrodinger", name: "Schrödinger", ticker: "SDGR", country: "US", role: "物理模擬 + AI 整合平台", howTo: "Schrödinger 提供分子動力學模擬 + 量子力學 + ML 整合平台，授權給 Big Pharma 並自主開發藥物管線。SGR-1505、SGR-2921 已進入臨床。", notes: "Schrödinger 商業模式分授權軟體（70% 營收）與藥物研發夥伴。Bill Gates 與 D.E. Shaw 為早期投資者，市值約 30 億美元。" },
        ],
        relationships: [
          "AlphaFold 為全球蛋白質結構預測黃金標準，開放數據庫覆蓋 2 億+ 結構",
          "Isomorphic Labs 為 Alphabet 商業化 AlphaFold 的旗艦公司",
          "Schrödinger 物理 + AI 雙引擎策略區隔於純 AI 路線競爭者",
        ],
      },
      {
        id: "ai-drug-discovery-startups",
        name: "AI 藥物發現公司",
        name_en: "AI Drug Discovery Startups",
        keyInfo: "AI 設計分子已進入臨床試驗，2026 首批 AI 設計藥物上市",
        marketType: "emerging",
        companies: [
          { id: "recursion", name: "Recursion Pharmaceuticals", ticker: "RXRX", country: "US", role: "用 NVIDIA BioHive-2 GPU 訓練生物模型", howTo: "Recursion BioHive-2 為製藥業最大超級電腦（504 顆 NVIDIA H100），每週生成 2.2 PB 資料。OS 平台整合細胞影像、化合物篩選、基因組學。2024 併購 Exscientia 後資料規模大幅擴展。", notes: "Recursion 與 Roche、Bayer、Sanofi 簽多項合作。市值約 25 億美元，2024 燒錢嚴重，但 NVIDIA 持股 5% 為利多。" },
          { id: "absci", name: "Absci", ticker: "ABSI", country: "US", role: "AI 設計抗體序列", howTo: "Absci 結合濕實驗室高通量抗體生成（每月 100 萬+ 抗體變體）與 AI 序列設計平台，de novo 設計抗體不依賴免疫動物。首個 AI 設計抗體 ABS-101 進入臨床。", notes: "與 AstraZeneca、Almirall 簽合作，每項目里程碑 2-3 億美元。市值約 5 億美元，仍處於早期臨床驗證階段。" },
          { id: "exscientia", name: "Exscientia (Recursion)", ticker: "RXRX", country: "UK", role: "Recursion 併購，AI 小分子設計", howTo: "Exscientia Centaur Chemist 平台 AI 設計小分子，曾為首個將 AI 設計分子推進臨床的公司。2024 11 月被 Recursion 全股票併購（8.5 億美元），形成 AI 藥物發現巨擘。", notes: "併購後 Recursion 整合 Centaur Chemist 與細胞影像平台，目標跨足小分子+生物製劑+細胞療法全方位 AI 藥物設計。" },
          { id: "relay", name: "Relay Therapeutics", ticker: "RLAY", country: "US", role: "Dynamo 平台模擬蛋白動態", howTo: "Relay Dynamo 平台模擬蛋白質構象變化（傳統靜態結構無法捕捉），找到隱藏的變構結合位點。RLY-2608（PI3Kα 突變選擇性抑制劑）為核心管線，第一/二期試驗中。", notes: "Relay 與 Genentech 合作 RLY-1971 (SHP2 抑制劑)。創辦人 D.E. Shaw 為對沖基金大老，市值約 5 億美元。" },
        ],
        relationships: [
          "Recursion + Exscientia 合併為 AI 藥物發現最大整合平台",
          "Absci 專注 AI 抗體設計，Relay 專注小分子蛋白動態",
          "AI 設計藥物臨床成功率仍待驗證，2026-2027 為關鍵觀察期",
        ],
      },
      {
        id: "ai-pharma-partnerships",
        name: "大藥廠 AI 合作",
        name_en: "Big Pharma AI Partnerships",
        keyInfo: "Big Pharma 與 AI 新創合作金額 2025 突破 100 億美元",
        marketType: "oligopoly",
        companies: [
          { id: "nvidia_bio", name: "NVIDIA BioNeMo", ticker: "NVDA", country: "US", role: "藥物發現 AI 平台與基礎模型", howTo: "NVIDIA BioNeMo 為生物製藥領域基礎模型平台，提供 ESM、AlphaFold、MolMIM 等預訓練模型與 DGX 訓練基礎設施。Recursion BioHive-2、Genentech、Amgen 等使用其平台。", notes: "NVIDIA 投資 Recursion (5%)、Genesis Therapeutics、Schrödinger 等多家 AI 藥物公司，建立藥物 AI 生態系。生醫雲端營收 2025 預估突破 50 億美元。" },
          { id: "lilly_ai", name: "Eli Lilly", ticker: "LLY", country: "US", role: "與 OpenAI、Recursion 簽 4 億美元合約", howTo: "Eli Lilly 與 OpenAI 合作開發抗微生物藥物 AI（2024）；與 Genetic Leap 開發 RNA 標靶 AI；與 Isomorphic Labs 簽 17 億美元合作。同時自建 AI 藥物實驗室 Lilly TuneLab。", notes: "Lilly 為 Ozempic 競爭者 Mounjaro、Zepbound 廠商，2025 市值突破 1 兆美元。AI 為藥物管線下一階段加速器，重點在新標靶與抗藥性。" },
          { id: "novartis_ai", name: "Novartis", ticker: "NVS", country: "CH", role: "與 Microsoft 簽 5 年策略合作", howTo: "Novartis 2019 與 Microsoft 簽 5 年策略合作（已續約至 2029），共建 Novartis AI Innovation Lab。同時與 Isomorphic Labs 簽 12 億美元合作。Generate:Biomedicines 合作探索蛋白生成 AI。", notes: "Novartis 為瑞士藥廠龍頭，市值約 2,500 億美元。AI 策略以軟體授權合作為主，避免自建 AI 團隊維護成本。" },
        ],
        relationships: [
          "NVIDIA BioNeMo 為 AI 藥物發現基礎設施標準",
          "Eli Lilly 與 Novartis 為 Big Pharma AI 投資最積極兩家",
          "Microsoft、OpenAI、Alphabet 三家科技巨頭爭奪 AI 製藥合作版圖",
        ],
      },
      {
        id: "ai-phenotype-screening",
        name: "AI 細胞影像與表型篩選",
        name_en: "AI Cell Imaging & Phenotypic Screening",
        keyInfo: "高通量 AI 影像分析每週處理 100 萬+ 細胞圖像",
        marketType: "high_growth",
        companies: [
          { id: "recursion_phenotype", name: "Recursion (Phenotype)", ticker: "RXRX", country: "US", role: "細胞圖像 AI 表型篩選領導", howTo: "Recursion 表型平台每週生成 220 萬張細胞影像，使用 CNN/Transformer 模型萃取 1024 維表型特徵。可同時測試 10 萬+ 化合物對 1000+ 細胞模型的影響。", notes: "Recursion 表型篩選優勢在於不依賴預設標靶假設，可發現 first-in-class 機制。劣勢為臨床轉譯仍需驗證。" },
          { id: "tempus", name: "Tempus AI", ticker: "TEM", country: "US", role: "臨床基因組與影像 AI 平台", howTo: "Tempus 整合 6 萬+ 患者臨床資料、組織病理影像、基因組與轉錄組，AI 提供精準腫瘤治療建議。Tempus xT 為廣泛基因組面板，xR 為 RNA 測序，整合至 Tempus ONE 臨床決策平台。", notes: "Tempus 2024 IPO 後市值約 70 億美元。創辦人 Eric Lefkofsky（Groupon 創辦人）。AstraZeneca 簽 2 億美元合作。台灣有合作夥伴雅捷生物。" },
        ],
        relationships: [
          "Recursion 表型篩選與 Tempus 臨床基因組為 AI 藥物發現兩大資料平台",
          "兩家皆依賴 NVIDIA GPU 進行大規模影像 AI 訓練",
          "資料規模優勢形成顯著護城河，後進者難以複製",
        ],
      },
      {
        id: "ai-pathology",
        name: "AI 病理學",
        name_en: "AI Pathology",
        keyInfo: "AI 病理診斷已獲 FDA 批准 30+ 項應用",
        marketType: "high_growth",
        companies: [
          { id: "tempus_path", name: "Tempus Labs", ticker: "TEM", country: "US", role: "AI 病理 + 基因組整合", howTo: "Tempus 整合病理切片數位影像（Whole Slide Imaging）與基因組資料，AI 自動標註腫瘤、預測治療反應與生存期。台灣三總、長庚等醫學中心已導入相關服務。", notes: "AI 病理需要解析高解析度切片（10 萬 x 10 萬像素），對 GPU 算力需求高。Tempus 與 PathAI、Paige.AI 為市場三強。" },
          { id: "veracyte", name: "Veracyte", ticker: "VCYT", country: "US", role: "AI 分子診斷甲狀腺/肺癌", howTo: "Veracyte Afirma GSC 為甲狀腺結節 AI 分子診斷（避免不必要手術），Decipher 用於前列腺癌復發風險預測，Percepta 用於肺結節惡性風險評估。皆需檢體送 Veracyte 中央實驗室。", notes: "Veracyte 2024 營收 4.5 億美元，Afirma 已成甲狀腺結節術前 AI 評估金標準。台灣由康健生技代理部分產品。" },
        ],
        relationships: [
          "Tempus 病理 AI 與基因組整合為癌症精準醫療標竿",
          "Veracyte 分子診斷 AI 改變甲狀腺與前列腺癌診斷流程",
          "AI 病理 + 液態生檢結合為下一階段精準醫療方向",
        ],
      },
      {
        id: "ai-clinical-trials",
        name: "AI 臨床試驗優化",
        name_en: "AI Clinical Trial Optimization",
        keyInfo: "AI 找受試者效率提升 5-10 倍，臨床試驗時間縮短 40%",
        marketType: "emerging",
        companies: [
          { id: "ginkgo", name: "Ginkgo Bioworks", ticker: "DNA", country: "US", role: "AI + 生物工廠設計", howTo: "Ginkgo 為合成生物學鑄造廠，AI 設計微生物代謝路徑生產特定分子。同時提供細胞編程、AI 蛋白工程與生物製造服務。Foundry 平台已執行 200+ 客戶專案。", notes: "Ginkgo 2024 與 Google 簽 AI 合作，整合大型語言模型至生物設計。市值大幅縮水至 7 億美元，仍處於商業模式驗證階段。" },
        ],
        relationships: [
          "Ginkgo 結合 AI 與合成生物學，為 AI 製藥的上游生物製造代表",
          "AI 臨床試驗優化領域大廠（Medidata、Veeva）尚未進入此分類",
          "Ginkgo 商業模式分為服務費 + 里程碑 + 權利金混合型",
        ],
      },
    ],
  },
  ...
  // ============================================================
  // sw/enterprise_saas — 企業 SaaS 與軟體生態系
  // ============================================================
  {
    id: "enterprise_saas",
    ...
    category: "sw",
    name: "企業 SaaS 與軟體生態系",
    name_en: "Enterprise SaaS & Software",
    description:
      "從網路安全、企業工作流、開發者平台到 AdTech 變現，覆蓋企業 SaaS 全棧，追蹤 2026 年軟體股結構性上漲驅動因素。",
    icon: "💼",
    color: "#3b82f6",
    flowSummary: "基礎設施 → 開發者平台 → 業務工作流 → 資料分析 → 垂直應用",
    sections: [
      {
        id: "saas-cybersecurity",
        name: "網路安全",
        name_en: "Cybersecurity",
        keyInfo: "AI 驅動威脅讓網路安全市場 2026 突破 $250B，平台型整合者最受惠",
        marketType: "oligopoly",
        companies: [
          { id: "crowdstrike", name: "CrowdStrike", ticker: "CRWD", country: "US", role: "Falcon 平台 — 雲原生 endpoint 防護領導者，~$5B ARR", marketShare: "~22%" },
          { id: "palo_alto", name: "Palo Alto Networks", ticker: "PANW", country: "US", role: "平台整合（XDR/SASE/Cloud），~$9B ARR，安全平台化標竿" },
          { id: "zscaler", name: "Zscaler", ticker: "ZS", country: "US", role: "Zero Trust Exchange 領導，SASE 主力供應商" },
          { id: "fortinet", name: "Fortinet", ticker: "FTNT", country: "US", role: "防火牆與 SD-WAN，全球網路安全硬體 ~25% 市佔", marketShare: "~25%" },
          { id: "sentinelone", name: "SentinelOne", ticker: "S", country: "US", role: "AI 驅動 EDR，Singularity 平台與 Purple AI 助理" },
          { id: "okta", name: "Okta", ticker: "OKTA", country: "US", role: "身份驗證與 SSO 領導，IDaaS 標竿" },
          { id: "cyberark", name: "CyberArk", ticker: "CYBR", country: "US", role: "特權存取管理（PAM）龍頭，企業憑證安全" },
        ],
        relationships: [
          "CrowdStrike、SentinelOne 在 AI EDR 直接競爭，CrowdStrike 規模領先",
          "Palo Alto Networks 以平台整合策略侵蝕點狀供應商市場",
          "Okta 與 CyberArk 在身份治理層形成互補（IDaaS + PAM）",
        ],
      },
      {
        id: "saas-workflow-itsm",
        name: "企業工作流與 ITSM",
        name_en: "Workflow & ITSM",
        keyInfo: "ServiceNow 整合 AI Agent 改寫企業工作流，Now Assist ARR 季增 50%+",
        marketType: "oligopoly",
        companies: [
          { id: "servicenow", name: "ServiceNow", ticker: "NOW", country: "US", role: "企業工作流 + AI Agent 領導，~$11B ARR，Now Assist 拓展 AI 變現" },
          { id: "atlassian", name: "Atlassian", ticker: "TEAM", country: "AU", role: "Jira + Confluence — 開發協作與專案管理標配" },
          { id: "salesforce", name: "Salesforce", ticker: "CRM", country: "US", role: "CRM 龍頭 + Einstein AI Agentforce 推動 AI Agent 變現" },
          { id: "workday", name: "Workday", ticker: "WDAY", country: "US", role: "HR + Finance SaaS，企業人資與財務雲端標準" },
          { id: "hubspot", name: "HubSpot", ticker: "HUBS", country: "US", role: "SMB CRM 與行銷自動化，AI Breeze 整合中小企業" },
          { id: "sap", name: "SAP", ticker: "SAP", country: "DE", role: "ERP 巨頭轉雲（RISE with SAP），Joule AI Copilot 強化生態系" },
        ],
        relationships: [
          "Salesforce Agentforce 與 ServiceNow Now Assist 在企業 AI Agent 市場直接競爭",
          "SAP 與 Workday 在 ERP/HR 市場互補，皆面臨 Oracle Fusion 競爭",
          "Atlassian 為開發者協作層，與 Salesforce/ServiceNow 業務層形成互補",
        ],
      },
      {
        id: "saas-developer-platforms",
        name: "開發者平台",
        name_en: "Developer Platforms",
        keyInfo: "AI 編碼革命推升開發者工具市值，Cursor/Copilot 帶動底層平台",
        marketType: "high_growth",
        companies: [
          { id: "mongodb", name: "MongoDB", ticker: "MDB", country: "US", role: "Atlas 雲端 NoSQL 領導，AI 向量搜尋功能擴張" },
          { id: "cloudflare", name: "Cloudflare", ticker: "NET", country: "US", role: "Workers AI 與邊緣運算，CDN 轉型為開發者平台" },
          { id: "gitlab", name: "GitLab", ticker: "GTLB", country: "US", role: "整合 DevSecOps 平台，Duo AI 與 GitHub Copilot 競爭" },
          { id: "elastic", name: "Elastic", ticker: "ESTC", country: "US", role: "搜尋與可觀察性，ELK Stack 商業化龍頭" },
          { id: "confluent", name: "Confluent", ticker: "CFLT", country: "US", role: "Apache Kafka 商業化，即時資料串流標準" },
          { id: "hashicorp", name: "HashiCorp", ticker: "HCP", country: "US", role: "Terraform 基礎設施即程式碼，2024 IBM 併購進行中" },
          { id: "twilio", name: "Twilio", ticker: "TWLO", country: "US", role: "CPaaS 通訊 API，AI 客戶互動平台轉型" },
        ],
        relationships: [
          "Cloudflare 邊緣 AI 與 MongoDB Atlas 在 AI 應用後端形成互補",
          "GitLab 與 GitHub（Microsoft）在 DevSecOps 平台直接對抗",
          "Confluent 與 Elastic 同屬資料管線層，分別在串流與搜尋稱霸",
        ],
      },
      {
        id: "saas-observability",
        name: "可觀察性與監控",
        name_en: "Observability & Monitoring",
        keyInfo: "AI 工作負載複雜度推升 APM 與 LLM 監控需求，Datadog 統治",
        marketType: "oligopoly",
        companies: [
          { id: "datadog", name: "Datadog", ticker: "DDOG", country: "US", role: "APM + 雲端觀察性領導，LLM Observability 擴張", marketShare: "~30%" },
          { id: "dynatrace", name: "Dynatrace", ticker: "DT", country: "US", role: "企業級觀察性，Davis AI 因果分析引擎" },
          { id: "splunk_cisco", name: "Splunk (Cisco)", ticker: "CSCO", country: "US", role: "SIEM 領導，2024 被 Cisco 以 $280 億併購整合" },
          { id: "grafana_labs", name: "Grafana Labs", ticker: "Private", country: "US", role: "開源觀察性平台領導，LGTM Stack（Loki/Grafana/Tempo/Mimir）" },
        ],
        relationships: [
          "Datadog 與 Dynatrace 在企業 APM 直接競爭，Datadog 雲原生勝出",
          "Cisco 併購 Splunk 整合網路 + SIEM，挑戰 Datadog 大型企業市場",
          "Grafana Labs 開源策略侵蝕付費觀察性供應商成長空間",
        ],
      },
      {
        id: "saas-data-analytics",
        name: "資料平台與分析",
        name_en: "Data Platforms & Analytics",
        keyInfo: "資料倉儲整合 AI 推升雲端資料平台 2026 市值，Snowflake/Databricks 雙雄",
        marketType: "oligopoly",
        companies: [
          { id: "snowflake", name: "Snowflake", ticker: "SNOW", country: "US", role: "Data Cloud 領導，Cortex AI 整合 LLM 與資料倉儲" },
          { id: "palantir", name: "Palantir", ticker: "PLTR", country: "US", role: "AIP 政府 + 企業 AI 平台，本體論驅動 AI Agent 部署" },
          { id: "databricks", name: "Databricks", ticker: "Private", country: "US", role: "Lakehouse 統一資料平台，Mosaic AI 與 Snowflake 直接對抗" },
          { id: "teradata", name: "Teradata", ticker: "TDC", country: "US", role: "傳統企業資料倉儲，VantageCloud 雲端轉型中" },
        ],
        relationships: [
          "Snowflake 與 Databricks 在資料雲市場雙寡頭爭霸，Databricks 預計 2026 IPO",
          "Palantir AIP 切入企業 AI Agent 部署，與 Databricks Mosaic 形成競爭",
          "Teradata 傳統資料倉儲面臨 Snowflake/Databricks 雲原生侵蝕",
        ],
      },
      {
        id: "saas-adtech",
        name: "AdTech 與 AI 變現",
        name_en: "AdTech & AI Monetization",
        keyInfo: "AppLovin AI 廣告平台 1 年股價 +400%，CTV 廣告爆發成長",
        marketType: "high_growth",
        companies: [
          { id: "applovin", name: "AppLovin", ticker: "APP", country: "US", role: "AI 廣告引擎 AXON 2.0，行動廣告變現顛覆者" },
          { id: "trade_desk", name: "The Trade Desk", ticker: "TTD", country: "US", role: "程序化購買龍頭 + CTV，Kokai 平台 AI 升級" },
          { id: "roku", name: "Roku", ticker: "ROKU", country: "US", role: "CTV 串流作業系統 + 廣告變現平台" },
          { id: "doubleverify", name: "DoubleVerify", ticker: "DV", country: "US", role: "廣告驗證與品牌安全測量領導" },
          { id: "magnite", name: "Magnite", ticker: "MGNI", country: "US", role: "SSP 領導，CTV 程序化供給端龍頭" },
          { id: "pubmatic", name: "PubMatic", ticker: "PUBM", country: "US", role: "SSP 與廣告基礎設施，獨立廣告交易所" },
        ],
        relationships: [
          "AppLovin AXON 2.0 顛覆傳統廣告網絡，挑戰 Meta/Google 廣告壟斷",
          "Trade Desk 與 AppLovin 分別在 DSP 與廣告引擎佔據兩端",
          "Magnite 與 PubMatic 在 SSP 直接競爭，CTV 為主要成長驅動力",
        ],
      },
      {
        id: "saas-communications",
        name: "通訊與生產力",
        name_en: "Communications & Productivity",
        keyInfo: "Microsoft Teams + Copilot 整合改寫企業通訊，Zoom 重塑 AI 助理定位",
        marketType: "oligopoly",
        companies: [
          { id: "zoom", name: "Zoom", ticker: "ZM", country: "US", role: "視訊會議 + Workplace，AI Companion 拓展企業協作" },
          { id: "ringcentral", name: "RingCentral", ticker: "RNG", country: "US", role: "統一通訊 UCaaS，與 Microsoft Teams 競爭" },
          { id: "five9", name: "Five9", ticker: "FIVN", country: "US", role: "雲端聯絡中心 CCaaS，AI Agent 客服自動化" },
          { id: "eight_x_eight", name: "8x8", ticker: "EGHT", country: "US", role: "UCaaS + CCaaS 整合平台，小型企業市場" },
        ],
        relationships: [
          "Microsoft Teams 整合 Copilot 對 Zoom/RingCentral 形成結構性壓力",
          "Five9 與 NICE 在雲端聯絡中心市場直接對抗",
          "8x8 規模較小，面臨 RingCentral 與 Microsoft 兩端擠壓",
        ],
      },
      {
        id: "saas-vertical",
        name: "垂直 SaaS",
        name_en: "Vertical SaaS",
        keyInfo: "垂直行業 SaaS 利潤率高且粘性強，AI 增強推升估值",
        marketType: "high_growth",
        companies: [
          { id: "shopify", name: "Shopify", ticker: "SHOP", country: "CA", role: "電商平台領導，Shop Pay 與 AI 商店助理擴張" },
          { id: "toast", name: "Toast", ticker: "TOST", country: "US", role: "餐飲 POS + SaaS，整合支付與線上點餐" },
          { id: "bill_com", name: "Bill.com", ticker: "BILL", country: "US", role: "SMB 財務自動化，AP/AR 自動化龍頭" },
          { id: "procore", name: "Procore", ticker: "PCOR", country: "US", role: "建築管理 SaaS，營建專案協作標準" },
          { id: "veeva", name: "Veeva", ticker: "VEEV", country: "US", role: "生命科學 SaaS，CRM 與臨床試驗管理領導" },
          { id: "tyler_tech", name: "Tyler Technologies", ticker: "TYL", country: "US", role: "政府 SaaS，州與地方政府 ERP 領導" },
        ],
        relationships: [
          "垂直 SaaS 高粘性護城河，AI 加值推升 ARPU 與毛利率",
          "Shopify 與 Toast 在 SMB 商務作業系統市場形成互補",
          "Veeva 在生命科學垂直 CRM 市場壟斷，Salesforce 難以滲透",
        ],
      },
      {
        id: "saas-design-creative",
        name: "設計與創意工具",
        name_en: "Design & Creative Tools",
        keyInfo: "AI 設計工具改寫創意產業，Figma 與 Adobe 雙雄競逐",
        marketType: "oligopoly",
        companies: [
          { id: "adobe", name: "Adobe", ticker: "ADBE", country: "US", role: "Creative Cloud + Firefly AI 生成模型，創意產業標準" },
          { id: "figma", name: "Figma", ticker: "FIG", country: "US", role: "協作設計平台，2026 IPO，AI 設計工具整合" },
          { id: "autodesk", name: "Autodesk", ticker: "ADSK", country: "US", role: "CAD/BIM 領導，AEC 產業設計軟體霸主" },
          { id: "canva", name: "Canva", ticker: "Private", country: "US", role: "大眾設計平台，Magic Studio AI 工具擴張" },
        ],
        relationships: [
          "Adobe 收購 Figma 失敗後，雙方在 UI 設計市場直接對抗",
          "Canva 以低價 + AI 普及策略侵蝕 Adobe 大眾用戶市場",
          "Autodesk 在工程設計垂直市場護城河深厚，AI 整合擴大 TAM",
        ],
      },
      {
        id: "saas-documents-esign",
        name: "電子簽章與文件",
        name_en: "Documents & eSignature",
        keyInfo: "Agentic AI 整合推升文件工作流自動化需求",
        marketType: "oligopoly",
        companies: [
          { id: "docusign", name: "DocuSign", ticker: "DOCU", country: "US", role: "電子簽章領導，IAM 智能協議管理平台轉型" },
          { id: "adobe_acrobat", name: "Adobe Acrobat", ticker: "ADBE", country: "US", role: "PDF + Adobe Sign 簽章雙巨頭" },
          { id: "dropbox", name: "Dropbox", ticker: "DBX", country: "US", role: "雲端儲存與協作，Dash AI 搜尋整合" },
        ],
        relationships: [
          "DocuSign 與 Adobe Sign 在企業電子簽章市場雙寡頭競爭",
          "Adobe 整合 Acrobat + Sign 形成 PDF 工作流閉環",
          "Dropbox 從儲存轉向 AI 工作流，差異化於文件搜尋",
        ],
      },
      {
        id: "saas-marketing-cdp",
        name: "行銷自動化與 CDP",
        name_en: "Marketing Automation & CDP",
        keyInfo: "客戶資料平台整合 AI 推送精準行銷成主流",
        marketType: "oligopoly",
        companies: [
          { id: "klaviyo", name: "Klaviyo", ticker: "KVYO", country: "US", role: "電商行銷自動化，與 Shopify 深度整合" },
          { id: "hubspot", name: "HubSpot", ticker: "HUBS", country: "US", role: "行銷與 CRM 整合平台，SMB 全棧 GTM" },
          { id: "zoominfo", name: "ZoomInfo", ticker: "ZI", country: "US", role: "B2B 銷售情報與意圖資料領導" },
          { id: "blackline", name: "BlackLine", ticker: "BL", country: "US", role: "財務自動化與帳目對帳 SaaS 領導" },
        ],
        relationships: [
          "Klaviyo 鎖定電商垂直，HubSpot 鎖定 SMB 通用行銷市場",
          "ZoomInfo 為 B2B 上層資料源，與 HubSpot/Salesforce CRM 整合",
          "Salesforce Marketing Cloud 為這些供應商共同的競爭對手",
        ],
      },
      {
        id: "saas-legal-compliance",
        name: "法務與合規",
        name_en: "Legal & Compliance",
        keyInfo: "AI 大幅縮短法務文件處理時間，垂直 AI 應用爆發",
        marketType: "emerging",
        companies: [
          { id: "legalzoom", name: "LegalZoom", ticker: "LZ", country: "US", role: "線上法務服務領導，SMB 法務自動化平台" },
          { id: "harvey_ai", name: "Harvey AI", ticker: "Private", country: "US", role: "法務專用大模型，頂級律師事務所首選 AI 助手" },
        ],
        relationships: [
          "Harvey AI 鎖定大型律所，LegalZoom 鎖定中小企業與消費者",
          "Thomson Reuters CoCounsel 為兩家共同的競爭對手",
          "法務垂直 AI 仍處於早期，2026-2027 為市場驗證關鍵期",
        ],
      },
    ],
  },
